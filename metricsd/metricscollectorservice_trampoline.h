...
#ifndef METRICSD_METRICSCOLLECTORSERVICE_TRAMPOLINE_H_
#define METRICSD_METRICSCOLLECTORSERVICE_TRAMPOLINE_H_
...
#endif  // METRICSD_METRICSCOLLECTORSERVICE_TRAMPOLINE_H_
