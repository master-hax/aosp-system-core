...
#ifndef METRICS_METRICS_COLLECTORS_H_
#define METRICS_METRICS_COLLECTORS_H_
...
class MetricsCollectors : public brillo::DBusDaemon {
 public:
  MetricsCollectors();
  ~MetricsCollectors();
 ...
 private:
  friend class MetricsCollectorsTest;
  FRIEND_TEST(MetricsCollectorsTest, CheckSystemCrash);
  FRIEND_TEST(MetricsCollectorsTest, ComputeEpochNoCurrent);
  FRIEND_TEST(MetricsCollectorsTest, ComputeEpochNoLast);
  FRIEND_TEST(MetricsCollectorsTest, GetHistogramPath);
  FRIEND_TEST(MetricsCollectorsTest, IsNewEpoch);
  FRIEND_TEST(MetricsCollectorsTest, MessageFilter);
  FRIEND_TEST(MetricsCollectorsTest, ProcessKernelCrash);
  FRIEND_TEST(MetricsCollectorsTest, ProcessMeminfo);
  FRIEND_TEST(MetricsCollectorsTest, ProcessMeminfo2);
  FRIEND_TEST(MetricsCollectorsTest, ProcessUncleanShutdown);
  FRIEND_TEST(MetricsCollectorsTest, ProcessUserCrash);
  FRIEND_TEST(MetricsCollectorsTest, ReportCrashesDailyFrequency);
  FRIEND_TEST(MetricsCollectorsTest, ReportKernelCrashInterval);
  FRIEND_TEST(MetricsCollectorsTest, ReportUncleanShutdownInterval);
  FRIEND_TEST(MetricsCollectorsTest, ReportUserCrashInterval);
  FRIEND_TEST(MetricsCollectorsTest, SendSample);
  FRIEND_TEST(MetricsCollectorsTest, SendZramMetrics);
...
#endif  // METRICS_METRICS_COLLECTORS_H_
