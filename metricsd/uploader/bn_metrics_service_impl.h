...
#ifndef METRICSD_UPLOADER_BN_METRICS_SERVICE_IMPL_H_
#define METRICSD_UPLOADER_BN_METRICS_SERVICE_IMPL_H_

#include "android/brillo/metrics/BnMetricsService.h"
#include "uploader/crash_counters.h"

class BnMetricsServiceImpl : public android::brillo::metrics::BnMetricsService {
 public:
  explicit BnMetricsServiceImpl(const std::shared_ptr<CrashCounters>& counters);
  virtual ~BnMetricsServiceImpl();
...
#endif  // METRICSD_UPLOADER_BN_METRICS_SERVICE_IMPL_H_
