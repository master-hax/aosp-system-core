...
BnMetricsServiceImpl::BnMetricsServiceImpl(
...
Status BnMetricsServiceImpl::recordLinearHistogram(const String16& name,
                                                   int sample,
                                                   int max) {
...
Status BnMetricsServiceImpl::recordSparseHistogram(const String16& name,
                                                   int sample) {
...
Status BnMetricsServiceImpl::recordCrash(const String16& type) {
