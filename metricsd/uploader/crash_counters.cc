...
void CrashCounters::IncrementKernelCrashCount() { kernel_crashes_++; }

unsigned int CrashCounters::GetAndResetKernelCrashCount() {
  return kernel_crashes_.exchange(0);
}

void CrashCounters::IncrementUncleanShutdownCount() { unclean_shutdowns_++; }

unsigned int CrashCounters::GetAndResetUncleanShutdownCount() {
  return unclean_shutdowns_.exchange(0);
}

void CrashCounters::IncrementUserCrashCount() { user_crashes_++; }
