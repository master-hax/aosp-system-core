...
void MetricsLog::IncrementUserCrashCount(int count) {
...
void MetricsLog::IncrementKernelCrashCount(int count) {
  metrics::SystemProfileProto::Stability* stability(
      uma_proto()->mutable_system_profile()->mutable_stability());
...
void MetricsLog::IncrementUncleanShutdownCount(int count) {
  metrics::SystemProfileProto::Stability* stability(
      uma_proto()->mutable_system_profile()->mutable_stability());
