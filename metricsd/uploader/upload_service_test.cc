...
class UploadServiceTest : public testing::Test {
 protected:
  virtual void SetUp() {
    ...
    upload_service_.reset(new UploadService("", base::TimeDelta(), base::TimeDelta(), private_dir_,
                                            shared_dir_, counters_));
...
TEST_F(UploadServiceTest, LogEmptyByDefault) {
  UploadService upload_service("", base::TimeDelta(),
                        base::TimeDelta(), dir_.path(), dir_.path(),
