...
metricsd_common := \
  persistent_integer.cc \
  uploader/binder_service.cc \
  uploader/binder_thread.cc \
...
metrics_includes := external/gtest/include \
  $(LOCAL_PATH)/include
libmetrics_shared_libraries := libchrome libbrillo libbinder libutils
...
# ========================================================
include $(CLEAR_VARS)
LOCAL_MODULE := metrics_binder_proxy
LOCAL_SHARED_LIBRARIES := libbinder libutils
LOCAL_SRC_FILES := aidl/android/brillo/IMetricsService.aidl
...
LOCAL_STATIC_LIBRARIES := metrics_binder_proxy
...
LOCAL_STATIC_LIBRARIES := metricsd_protos metrics_binder_proxy
...
LOCAL_STATIC_LIBRARIES := libBionicGtestMain libgmock metricsd_protos metrics_binder_proxy
...
LOCAL_SRC_FILES := $(metrics_collector_tests_sources) \
  $(metrics_collector_common)
LOCAL_STATIC_LIBRARIES := libBionicGtestMain libgmock metrics_binder_proxy
include $(BUILD_NATIVE_TEST)
