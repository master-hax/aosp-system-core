...
int UeventListener::ReadUevent(Uevent* uevent) const {
    ...
    if (n >= UEVENT_MSG_LEN) {
        ...
        // Return 0 in this case, where the Uevent was successfully read but is invalid, so that
        // the caller can skip processing this and continue reading further pending uevents.
        return 0;
    }
