...
Result<Nothing> ModaliasHandler::ParseDepCallback(std::vector<std::string>&& args) {
...
Result<Nothing> ModaliasHandler::ParseAliasCallback(std::vector<std::string>&& args) {
    auto it = args.begin();
...
Result<Nothing> ModaliasHandler::Insmod(const std::string& path_name, const std::string& args) {
    base::unique_fd fd(
...
Result<Nothing> ModaliasHandler::InsmodWithDeps(const std::string& module_name,
