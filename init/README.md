...
or `stop` commands on it respectively.

> Note that the interface name may be either a fully qualified HIDL name
(`android.hardware.secure_element@1.1::ISecureElement/eSE1`) or an AIDL name
