...
> Set task profiles. For Android U and before, the profiles are applied to the main thread of the
  service. For Android V and later, the profiles are applied to the entire service process. This
  is designed to replace the use of writepid option for moving a process into a cgroup.
