...
> Fork and execute command with the given arguments. This is parsed identically
  to the `exec` command. They difference is that init does not halt executing
  commands until the process exits.
