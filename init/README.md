...
System properties can be expanded using the syntax `$property.name` or
`${property.name}`. The latter is useful in contexts where concatenation
is required, such as `import /init.recovery.${ro.hardware}.rc`.
