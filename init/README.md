...
> Install the module at _path_ with the specified options.
  ...
  This, as part of `on first-stage-init` trigger, is the only command available
  in first stage init phase.
...
Nonetheless, the de facto order for first stage mount devices are:
