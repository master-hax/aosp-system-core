...
class Parser {
  public:
    ...
    bool ParseConfig(const std::string& path, unsigned int* parse_errors);
    void AddSectionParser(const std::string& name, std::unique_ptr<SectionParser> parser);
    void AddSingleLineParser(const std::string& prefix, LineCallback callback);

  private:
    void ParseData(const std::string& filename, const std::string& data, unsigned int* parse_errors);
    bool ParseConfigFile(const std::string& path, unsigned int* parse_errors);
    bool ParseConfigDir(const std::string& path, unsigned int* parse_errors);
