...
//  function return Result<Success> indicating if they have an error. It will be reported along with
//  the filename and line number of where the error occurred.
//
//  1) Result<Success> ParseSection(std::vector<std::string>&& args, const std::string& filename,
