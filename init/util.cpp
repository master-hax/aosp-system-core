...
// CloseStdioFds() is used to close these existing fds if they exist and replace them with
// /dev/null regardless.
//
...
//
// Lastly, simply calling CloseStdioFds() in first stage init is not enough, since first
...
// CloseStdioFds() must be called again in second stage init.
void CloseStdioFds(char** argv) {
