...
TEST(util, ReadFile_ENOENT) {
    ...
    EXPECT_EQ("open() failed: No such file or directory", file_contents.error().error_string);
}
...
TEST(util, ReadFileGroupWriteable) {
    ...
    EXPECT_EQ("Skipping insecure file", file_contents.error().error_string);
}
...
TEST(util, ReadFileSymbolicLink) {
    ...
    ASSERT_FALSE(file_contents);
    EXPECT_EQ("open() failed: Too many symbolic links encountered", file_contents.error().error_string);
}
...
TEST(util, DecodeUid) {
    ...
    EXPECT_EQ("getpwnam failed: No such file or directory", decoded_uid.error().error_string);
