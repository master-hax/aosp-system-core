...
bool SetupMountNamespaces() {
    ...
    // the bootstrap namespace gets APEXes from the read-only partition.
...
// TODO(jiyong): remote this when /system/lib/libc.so becomes
// a symlin to /apex/com.android.runtime/lib/bionic/libc.so
bool SetupRuntimeBionic() {
    ...
    LOG(INFO) << "Runtime bionic is setup";
    return true;
}
