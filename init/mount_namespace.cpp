...
bool SetupMountNamespaces() {
    ...
    // /system/etc/linkerconfig is a private mountpoint to give a different linker configuration
    // based on the mount namespace. Subdirectory named 'current' will be bind-mounted from one of
    // the many configuration subdirectory based on the status.
