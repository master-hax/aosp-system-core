...
bool SetupMountNamespaces() {
    ...
    // as "shared" and bind-mount /bootstrapapex to /apex before entering
    // the default mount namespace. In the default mount namespace, we detach
    // /bootstrapapex and make /apex private. Then, even in the default
    // mount namespace, bootstrap APEXes are still visible from /bootstrapapex.
    //
    ...
    if (NeedsTwoMountNamespaces()) {
        if (!(BindMount("/bootstrapapex", "/apex"))) return false;
    }
