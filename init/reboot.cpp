...
static Result<void> DoUserspaceReboot() {
    ...
    auto sigterm_timeout = GetMillisProperty("ro.init.userspace_reboot.sigterm_timeout", 5s);
    auto sigkill_timeout = GetMillisProperty("ro.init.userspace_reboot.sigkill_timeout", 10s);
...
static void UserspaceRebootWatchdogThread() {
    ...
    auto timeout = GetMillisProperty("ro.init.userspace_reboot.watchdog_timeout", 5min);
