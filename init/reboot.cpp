...
void DoReboot(unsigned int cmd, const std::string& reason, const std::string& rebootTarget,
    ...
    const std::unordered_set<std::string> firstToKills{"tombstoned"};
    const std::unordered_set<std::string> killAfterApps{"logd", "adbd"};
    // watchdogd is a vendor specific component but should be alive to complete shutdown safely.
    const std::unordered_set<std::string> toStarts{"watchdogd", "vold"};
