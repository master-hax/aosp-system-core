...
int ueventd_main(int argc, char** argv) {
    ...
    // mount namespace and APEXd mounts all APEXes within it. To support loading
    // firmwares from APEXes ueventd also switches to "default" when apexd.status=ready.
