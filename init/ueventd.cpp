...
//    the generated uevents.  It writes these uevents into into a queue represented.
//
...
//
// 4) Once the restorecon operation finishes, the main thread calls wait() to wait for all
...
void Ueventd::UeventHandlerMain(unsigned int process_num, unsigned int total_processes) {
...
void Ueventd::DoColdBoot() {
    ...
    uevent_listener_.RegenerateUevents([this, &uevents_seen](const Uevent& uevent) {
        ++uevents_seen;
...
int Ueventd::Run() {
    ...
    uevent_listener_.DoPolling([this](const Uevent& uevent) {
        HandleFirmwareEvent(uevent);
...
int ueventd_main(int argc, char** argv) {
    ...
    // TODO: Don't do this, handle SIGCHLD appropriately.
