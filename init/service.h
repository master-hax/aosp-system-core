...
class Service {
  ...
  public:
    ...
    static void OpenAndSaveStaticKallsymsFd() { CreateSharedKallsymsFd(); }
  ...
  private:
    ...
    bool shared_kallsyms_file_; // if true, pass the service a pre-opened fd to
                                // /proc/kallsyms with full address visibility
