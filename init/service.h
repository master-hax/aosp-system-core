...
class Service {
  ...
  private:
    ...
    bool ParseSwappiness(const std::vector<std::string>& args, std::string* err);
    bool ParseLimitInBytes(const std::vector<std::string>& args, std::string* err);
    bool ParseSoftLimitInBytes(const std::vector<std::string>& args, std::string* err);
