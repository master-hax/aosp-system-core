...
// apps or not.
#define SVC_SHUTDOWN_FLAGS_START 0x100  // Whether or not to start the service on shutdown.

#define SVC_SHUTDOWN_FLAGS_AFTER_APPS_SIGTERM \
    0x10000  // Whether or not the service should be started
