...
struct socketinfo { //TODO(tomcherry) c++'ify this
...
struct svcenvinfo { //TODO(tomcherry) c++'ify this
...
class Service {
public:
    //friend ServiceManager::MakeExecOneshotService(const std::vector<std::string>& args);
    friend ServiceManager; // for MakeExecOneshotService
    ...
    void Start(const char* dynamic_args);
    ...
    std::string get_classname() const { return classname_; }
    unsigned get_flags() const { return flags_; }
    pid_t get_pid() const { return pid_; }
    int get_keychord_id() const { return keychord_id_; }
...
public:
    ...
    Service* ServiceFindByName(const std::string& name);
    Service* ServiceFindByPid(pid_t pid);
    Service* ServiceFindByKeychord(int keychord_id);
    void ServiceForEach(void (*func)(Service* svc));
