...
void ActionQueue::queue_event_trigger(const std::string& trigger)
{
...
void ActionQueue::queue_property_trigger(const std::string& name,
...
void ActionQueue::queue_builtin_action(int (*func)(int nargs, char** args),
...
bool ActionQueue::has_more_commands() const
{
...
void ActionQueue::dump_parser_state() const
{
    for (auto& a : action_list) {
        INFO("on ");
