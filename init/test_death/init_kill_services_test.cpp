...
class InitKillServiceTest : public ::testing::TestWithParam<std::string> {};

TEST_P(InitKillServiceTest, KillCriticalProcesses) {
...
INSTANTIATE_TEST_CASE_P(DeathTest, InitKillServiceTest,
