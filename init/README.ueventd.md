...
`external_firmware_handler` line in a ueventd.rc file. This line takes the format of
    ...
    external_firmware_handler <devpath> <path to external program>
For example

    external_firmware_handler /devices/leds/red/firmware/coeffs.bin /vendor/bin/led_coeffs.bin
Will launch `/vendor/bin/led_coeffs.bin` instead of serving the default firmware for
`/devices/leds/red/firmware/coeffs.bin`.
