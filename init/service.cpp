...
bool ParseIoprio(std::string ioclass_str, std::string ioprio_str, IoSchedClass* ioprio_class,
                 int* ioprio_pri, std::string* err) {
...
bool ParsePriority(std::string arg, int* prio, std::string* err) {
    *prio = 0;
    if (!android::base::ParseInt(arg, prio,
