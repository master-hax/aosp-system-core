...
// Check Uevents looking for the kernel's boot parition UUID
//
...
bool DeviceHandler::CheckUeventForBootPartUuid(const Uevent& uevent) {
    ...
    if (boot_devices_.size()) {
        ...
        //   soc@0/a6f8800.usb/a600000.usb/xhci-hcd.11.auto/usb2/2-1/2-1.3/2-1.3.2/2-1.3.2:1.0/host0/target0:0:0/0:0:0:0
