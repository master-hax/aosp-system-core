...
TEST(ueventd_parser, ExternalFirmwareHandlers) {
    auto ueventd_file = R"(
external_firmware_handler devpath firmware handler_path
external_firmware_handler /devices/path/etc something001.bin /vendor/bin/firmware_handler.sh
external_firmware_handler /devices/path/etc something001.bin "/vendor/bin/firmware_handler.sh --has --arguments"
)";
...
external_firmware_handler /devices/path firmware001.bin /vendor/bin/touch.sh
...
uevent_socket_rcvbuf_size 6M
    ...
    auto external_firmware_handlers = std::vector<ExternalFirmwareHandler>{
            {"/devices/path", "firmware001.bin", "/vendor/bin/touch.sh"},
    };
