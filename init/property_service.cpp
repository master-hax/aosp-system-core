...
static int read_api_level_props(std::vector<std::string> api_level_props) {
...
static void property_initialize_ro_vendor_api_level() {
    ...
    int board_api_level = read_api_level_props(BOARD_API_LEVEL_PROPS);
    int device_api_level = read_api_level_props(DEVICE_API_LEVEL_PROPS);
    int api_level = board_api_level < device_api_level ? board_api_level : device_api_level;
