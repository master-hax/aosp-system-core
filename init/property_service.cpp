...
static void HandleInitSocket() {
    ...
    switch (init_message.msg_case()) {
        case InitMessage::kLoadPersistentProperties: {
            ...
            bool has_staging_prop = false;
            auto const staged_prefix = std::string("next_boot.");
            auto const staged_persist_prefix = std::string("next_boot.persist.");
            ...
            if (has_staging_prop) {
                ...
                if (auto result = WritePersistentPropertyFile(updated_persist_props); !result.ok()) {
