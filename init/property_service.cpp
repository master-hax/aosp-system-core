...
void property_load_boot_defaults() {
    if (!load_properties_from_file("/system/etc/default.prop", NULL)) {
        // for legacy devices
        if (!load_properties_from_file("/default.prop", NULL)) {
            PLOG(ERROR) << "Failed to load default.prop";
        }
    }
    load_properties_from_file("/odm/etc/default.prop", NULL);
    load_properties_from_file("/vendor/etc/default.prop", NULL);
...
void load_system_props() {
    if (!load_properties_from_file("/system/etc/build.prop", NULL)) {
        // for legacy devices
        load_properties_from_file("/system/build.prop", NULL);
    }
    if (!load_properties_from_file("/odm/etc/build.prop", NULL)) {
        // for legacy devices
        load_properties_from_file("/odm/build.prop", NULL);
    }
    if (!load_properties_from_file("/vendor/etc/build.prop", NULL)) {
        // for legacy devices
