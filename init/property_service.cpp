...
void property_load_boot_defaults() {
    ...
    load_properties_from_file("/odm/etc/prop.default", NULL);
    load_properties_from_file("/vendor/etc/prop.default", NULL);
...
void load_system_props() {
    if (!load_properties_from_file("/system/etc/prop.build", NULL)) {
        // for legacy devices
        load_properties_from_file("/system/build.prop", NULL);
    }
    load_properties_from_file("/odm/etc/prop.build", NULL);
    if (!load_properties_from_file("/vendor/etc/prop.build", NULL)) {
        // for legacy devices
