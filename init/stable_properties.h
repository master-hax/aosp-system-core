...
class StableActionablePropertyManager {
  ...
  private:
    ...
    void LoadExceptionalActionableProperties(const std::string& data);
    void LoadExceptionalActionablePropertyFile();

    bool enabled_;
    std::set<std::string> exported_actionable_properties_;
    std::set<std::string> exceptional_actionable_properties_;
