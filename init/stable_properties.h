...
class StableActionablePropertyManager {
  public:
    static StableActionablePropertyManager& GetInstance();

    bool IsActionable(const std::string& prop_name);

  private:
    StableActionablePropertyManager();

    void LoadExtendedActionableProperties(char* data);
    void LoadExtendedActionablePropertyFiles();

    bool enforced_;
    std::vector<std::string> partner_prefixes_;
    std::set<std::string> exported_actionable_properties_;
    std::set<std::string> extended_actionable_properties_;
    ...
    static constexpr const char* kExportedActionableProperties[] = {
