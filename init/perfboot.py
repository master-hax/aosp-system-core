...
def disable_dropbox():
    ...
    original_dropbox_max_files = run_adb(
...
def restore_dropbox(original_dropbox_max_files):
    ...
    if original_dropbox_max_files == 'null':
        ...
        run_adb(['shell', 'settings', 'put', 'global',
                 'dropbox_max_files', original_dropbox_max_files])
...
def init_perf(output, record_list, tags):
    ...
    if build_type != 'user':
        ...
        original_dropbox_max_files = disable_dropbox()
    ...
    def cleanup():
        try:
            ...
            if original_dropbox_max_files is not None:
                restore_dropbox(original_dropbox_max_files)
        except subprocess.CalledProcessError:
            pass
