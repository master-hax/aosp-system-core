...
void StderrLogger(android::base::LogId, android::base::LogSeverity, const char*, const char*,
...
int main(int argc, char** argv) {
    ...
    if (parser.parse_errors() > 0) {
        LOG(ERROR) << "Init script parsing failed with " << parser.parse_errors() << " errors";
        return -1;
    }
    return 0;
}
