...
Result<Nothing> EnterNamespace(int nstype, const char* path) {
...
Result<Nothing> SetUpMountNamespace(bool remount_proc, bool remount_sys) {
...
Result<Nothing> SetUpPidNamespace(const char* name) {
...
Result<Nothing> EnterNamespaces(const NamespaceInfo& info, const std::string& name,
                                bool pre_apexd) {
...
Result<Nothing> SetProcessAttributes(const ProcessAttributes& attr) {
...
Result<Nothing> WritePidToFiles(std::vector<std::string>* files) {
