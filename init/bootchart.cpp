...
static Result<Nothing> do_bootchart_start() {
...
static Result<Nothing> do_bootchart_stop() {
    if (!g_bootcharting_thread) return Nothing();
...
Result<Nothing> do_bootchart(const BuiltinArguments& args) {
