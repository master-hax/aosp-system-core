...
// partition_names. Note that the partition_names should have A/B suffix
...
void early_device_init(std::set<std::string>* partition_names) {
...
bool get_early_partitions(const std::vector<fstab_rec*>& early_fstab_recs,
