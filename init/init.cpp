...
static void SetKernelVersion() {
    ...
    SetProperty("ro.kernel.version_sysname", uts.sysname);
    SetProperty("ro.kernel.version_nodename", uts.nodename);
    SetProperty("ro.kernel.version_release", uts.release);
    SetProperty("ro.kernel.version_version", uts.version);
    SetProperty("ro.kernel.version_machine", uts.machine);
}
