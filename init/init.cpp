...
int main(int argc, char** argv) {
    ...
    if (is_first_stage) {
        ...
        mount("tmpfs", "/dev", "tmpfs", MS_NOSUID | MS_NOEXEC, "mode=0755");
        mkdir("/dev/pts", 0755);
        mkdir("/dev/socket", 0755);
        mount("devpts", "/dev/pts", "devpts", MS_NOEXEC, NULL);
        ...
        mount("sysfs", "/sys", "sysfs", MS_NOEXEC, NULL);
        mount("selinuxfs", "/sys/fs/selinux", "selinuxfs", MS_NOEXEC, NULL);
