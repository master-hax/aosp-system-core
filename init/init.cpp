...
static const std::map<std::string, ControlMessageFunction>& get_control_message_map() {
    ...
    static const std::map<std::string, ControlMessageFunction> control_message_functions = {
        ...
        {"oneshot_on",        {ControlTarget::SERVICE,
                               [](auto* service) { service->set_oneshot(true); return Result<void>{}; }}},
        {"oneshot_off",       {ControlTarget::SERVICE,
                               [](auto* service) { service->set_oneshot(false); return Result<void>{}; }}},
