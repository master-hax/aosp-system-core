...
static void restart_processes()
{
    ...
    ServiceManager::GetInstance().
        ServiceForEachFlags(SVC_RESTARTING, [] (Service* s)
...
{
    if (!msg.compare("start")) {
        msg_start(arg);
    } else if (!msg.compare("stop")) {
        msg_stop(arg);
    } else if (!msg.compare("restart")) {
        msg_restart(arg);
    } else {
