...
TEST(SubcontextTest, CheckDifferentPid) {
...
TEST(SubcontextTest, MultipleCommands) {
    RunTest([](auto& subcontext, auto& context_string) {
...
TEST(SubcontextTest, RecoverAfterAbort) {
    RunTest([](auto& subcontext, auto& context_string) {
        auto first_pid = subcontext.pid();
...
TEST(SubcontextTest, ContextString) {
    RunTest([](auto& subcontext, auto& context_string) {
