...
TEST(result, result_success_rvalue) {
    ...
    EXPECT_EQ(std::monostate(), *MakeRvalueSuccessResult());
    EXPECT_EQ(std::monostate(), MakeRvalueSuccessResult().value());
}
...
struct ConstructorTracker {
    ...
    ConstructorTracker(ConstructorTracker&& ct) {
        ++move_constructor_called;
        string = std::move(ct.string);
    }
    ConstructorTracker& operator=(const ConstructorTracker& ct) noexcept {
