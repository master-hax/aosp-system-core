...
// Note that these cannot check expanded arguments from properties, since they will not know what
// those properties would be at runtime.  They will be passed an empty string in the situation that
// the input line had a property expansion, since an empty string is otherwise an invalid value.
