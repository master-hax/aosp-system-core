...
class FirstStageMount {
  ...
  protected:
    ...
    bool forbid_check_most_at_once_ = false;
...
bool FirstStageMount::TrySwitchSystemAsRoot() {
    ...
    if (MountPartition(system_partition, false)) {
        if (forbid_check_most_at_once_ && fs_mgr_verity_is_check_at_most_once(*system_partition)) {
...
void FirstStageMount::UseGsiIfPresent() {
    ...
    forbid_check_most_at_once_ = (super_name != "userdata");
}
