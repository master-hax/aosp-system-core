...
TEST(service, make_temporary_service_invalid_syntax) {
    std::vector<std::string> args;
    // Nothing.
    ASSERT_EQ(nullptr, Service::MakeTemporaryService(args));
...
TEST(service, make_temporary_service_too_many_supplementary_gids) {
    std::vector<std::string> args;
    args.push_back("exec");
...
static void Test_make_temporary_service(bool dash_dash, bool seclabel, bool uid, bool gid,
    ...
    args.push_back("id");
    auto svc = Service::MakeTemporaryService(args);
...
TEST(service, make_temporary_service_with_everything) {
    Test_make_temporary_service(true, true, true, true, true);
}

TEST(service, make_temporary_service_with_seclabel_uid_gid) {
    Test_make_temporary_service(true, true, true, true, false);
}

TEST(service, make_temporary_service_with_seclabel_uid) {
    Test_make_temporary_service(true, true, true, false, false);
}

TEST(service, make_temporary_service_with_seclabel) {
    Test_make_temporary_service(true, true, false, false, false);
}

TEST(service, make_temporary_service_with_just_command) {
    Test_make_temporary_service(true, false, false, false, false);
}

TEST(service, make_temporary_service_with_just_command_no_dash) {
    Test_make_temporary_service(false, false, false, false, false);
}
