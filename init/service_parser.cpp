...
Result<void> ServiceParser::ParseSection(std::vector<std::string>&& args,
    ...
    std::string apex_name = subcontext_ && from_apex_ ? subcontext_->GetApexName(filename) : "";

    service_ = std::make_unique<Service>(name, restart_action_subcontext, str_args, from_apex_, apex_name);
    return {};
}
