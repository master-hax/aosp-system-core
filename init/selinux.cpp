...
bool LoadSplitPolicy() {
    ...
    std::string nonplat_declaration_cil_file("/vendor/etc/selinux/filter/nonplat_declaration.cil");
    ...
    if (access(vendor_policy_cil_file.c_str(), F_OK) == -1) {
        ...
        LOG(ERROR) << "Missing /vendor/etc/selinux/filter/nonplat_declaration.cil";
        return false;
    }
