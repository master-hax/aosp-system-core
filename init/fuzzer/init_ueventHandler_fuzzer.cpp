...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    while (fdp.remaining_bytes()) {
        auto invokeUeventHandlerFuzzer = fdp.PickValueInArray<const std::function<void()>>({
                [&]() {
                ...
                [&]() {
                    ...
                    FirmwareHandler firmwareHandler =
                            FirmwareHandler(firmwareDirectories, externalHandlers);
