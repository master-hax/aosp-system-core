...
const std::string kdevice_paths[] = {
        "/devices/soc.0/f9824900.sdhci/mmc_host/mmc0/mmc0:0001/block/mmcblk0",
        "/devices/soc.0/f9824900.sdhci/mmc_host/mmc0/mmc0:0001/block/mmcblk0p1",
        "/devices/pci0000:00/0000:00:1f.2/mmcblk0", "/devices/vbd-1234/mmcblk0"};
...
Uevent getUevent(FuzzedDataProvider* fdp) {
    ...
    uevent.path = fdp->PickValueInArray(kdevice_paths);
    ...
    uevent.device_name = fdp->PickValueInArray(kDeviceName);
