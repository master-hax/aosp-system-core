...
class InitParserFuzzer {
  ...
  private:
    ...
    InterfaceInheritanceHierarchyMap generateHeirarchyMap();
...
InterfaceInheritanceHierarchyMap InitParserFuzzer::generateHeirarchyMap() {
...
void InitParserFuzzer::invokeInterfaceUtils() {
    InterfaceInheritanceHierarchyMap heirarchyMap = generateHeirarchyMap();
    SetKnownInterfaces(heirarchyMap);
    ...
    CheckInterfaceInheritanceHierarchy(interfaceSet, heirarchyMap);
}
