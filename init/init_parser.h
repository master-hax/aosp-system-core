...
public:
    ...
    virtual bool ParseSection(std::vector<std::string>&& args, std::string* err) = 0;
    virtual bool ParseLineSection(std::vector<std::string>&& args, std::string&& filename, int line,
