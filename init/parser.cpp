...
bool Parser::ParseConfigFile(const std::string& path, unsigned int* parse_errors) {
...
bool Parser::ParseConfigDir(const std::string& path, unsigned int* parse_errors) {
...
bool Parser::ParseConfig(const std::string& path, unsigned int* parse_errors) {
    *parse_errors = 0;
