...
exec <user> <group> <seccontext> <command> [ <argument> ]*
   Fork and execute <command>, running as the given user and group
   in the given security context. No other commands will be run until
   this one finishes.
