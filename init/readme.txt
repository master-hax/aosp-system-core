...
All services whose binaries reside on the system, vendor, and odm
...
system macro, LOCAL_INIT_RC, that handles this for developers.  This
...
the service to be run and action to be queued when appropriate.

This break up of init .rc files according to their daemon is preferred
to the previously used monolithic init .rc files.
