...
static NativeBridgeRuntimeCallbacks* runtime_callbacks;
...
struct NativeBridgeCallbacks {
  ...
  bool (*initialize)(NativeBridgeRuntimeCallbacks* runtime_cbs);
...
void SetupNativeBridge(const std::string& nb_library_string, NativeBridgeRuntimeCallbacks* runtime_cbs) {
