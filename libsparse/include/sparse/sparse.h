 ...
 *                           data (including holes) will be be converted to a
 *                           fill chunks.
 ...
 *
 * Reads a file into a sparse file cookie. If mode is @SPARSE_READ_MODE_SPARSE,
 * the file is assumed to be in the Android sparse file format. If mode is
 * @SPARSE_READ_MODE_NORMAL, the file will be sparsed by looking for block
 * aligned chunks of all zeros or another 32 bit value. If mode is
 * @SPARSE_READ_MODE_HOLE, the file will be sparsed like
