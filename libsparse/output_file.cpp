...
struct sparse_file_ops {
  ...
  int (*write_fill_chunk)(struct output_file* out, unsigned int len, uint64_t fill_val);
...
static int write_sparse_fill_chunk(struct output_file* out, unsigned int len, uint64_t fill_val) {
  chunk_header_t chunk_header;
...
static int write_normal_fill_chunk(struct output_file* out, unsigned int len, uint64_t fill_val) {
  int ret;
  unsigned int i;
