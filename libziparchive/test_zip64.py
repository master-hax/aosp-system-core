...
class Zip64Test(unittest.TestCase):
  ...
  def test_entriesSmallerThan2G(self):
    ...
    # Add a few large entries, but each of them is smaller than 2GiB. And the zip file is larger
    # than 4GiB in size.
  ...
  def test_largeCompressedEntries(self):
    ...
    with zipfile.ZipFile(zip_path, 'w', compression=zipfile.ZIP_DEFLATED,
      ...
      # size in the extra field. Our ziptool should be able to parse it.
