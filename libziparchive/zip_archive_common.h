...
// The layout of the Zip64 Extended Information Extra Field. It may appear in
// the 'extra' field of a central directory record or local file header.
// This entry in the Local header MUST include BOTH original and compressed file
// size fields. The order of the fields in the zip64 extended information record
...
struct Zip64ExtendedInfo {
  ...
  // Optional field to hold the local header offset.
