...
std::pair<ZipErrorCodes, uint64_t> CdEntryMapZip32::GetCdEntryOffset(std::string_view name,
...
ZipErrorCodes CdEntryMapZip32::AddToMap(std::string_view name, const uint8_t* start) {
...
ZipErrorCodes CdEntryMapZip64::AddToMap(std::string_view name, const uint8_t* start) {
...
std::pair<ZipErrorCodes, uint64_t> CdEntryMapZip64::GetCdEntryOffset(
    std::string_view name, const uint8_t* /*cd_start*/) const {
