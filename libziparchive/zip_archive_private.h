...
class CdEntryMapInterface {
 public:
  ...
  virtual ZipErrorCodes AddToMap(std::string_view name, const uint8_t* start) = 0;
  ...
  virtual std::pair<ZipErrorCodes, uint64_t> GetCdEntryOffset(std::string_view name,
...
class CdEntryMapZip32 : public CdEntryMapInterface {
 public:
  ...
  ZipErrorCodes AddToMap(std::string_view name, const uint8_t* start) override;
  std::pair<ZipErrorCodes, uint64_t> GetCdEntryOffset(std::string_view name,
