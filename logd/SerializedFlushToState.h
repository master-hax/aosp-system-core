...
// construction, must be done with SerializedLogBuffer::logs_lock_ held.  No log chunks that it
...
class SerializedFlushToState : public FlushToState {
  ...
  private:
    ...
    // Create a LogPosition element for the given log_id by searching through the log chunks for the
