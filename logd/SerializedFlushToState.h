...
class SerializedFlushToState : public FlushToState {
  public:
    ...
    // If the parent log buffer prunes logs, the references that this class contains will become
    // invalid and this function must be called to clear them.
    void AfterClear(log_id_t log_id);
