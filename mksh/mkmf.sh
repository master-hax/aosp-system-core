...
# directory, like so: sh .../system/core/mksh/mkmf.sh
...
#XXX TODO sort, clean up, do something with it

cd "$(dirname "$0")/../../.."
CC=prebuilt/linux-x86/toolchain/arm-eabi-4.4.0/bin/arm-eabi-gcc
addvar CPPFLAGS -Isystem/core/include -Ihardware/libhardware/include \
    -Isystem/core/include -Ihardware/libhardware/include \
    -Ihardware/libhardware_legacy/include -Ihardware/ril/include \
    -Idalvik/libnativehelper/include -Iframeworks/base/include \
    -Iframeworks/base/opengl/include -Iexternal/skia/include \
    -Iout/target/product/generic/obj/include -Ibionic/libc/arch-arm/include \
    -Ibionic/libc/include -Ibionic/libstdc++/include \
    -Ibionic/libc/kernel/common -Ibionic/libc/kernel/arch-arm \
    -Ibionic/libm/include -Ibionic/libm/include/arch/arm \
    -Ibionic/libthread_db/include
...
addvar CPPFLAGS -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ \
    -D__ARM_ARCH_5TE__ -Isystem/core/include/arch/linux-arm/ -DANDROID \
    -include system/core/include/arch/linux-arm/AndroidConfig.h
addvar CFLAGS -Wall -Wextra -Wno-unused -Winit-self -Wpointer-arith \
    -Werror=return-type -Werror=non-virtual-dtor -Werror=address \
    -Werror=sequence-point -mthumb -Os -fomit-frame-pointer \
    -fno-strict-aliasing -finline-limit=64
addvar CPPFLAGS -DNDEBUG -UDEBUG
addvar LDFLAGS -nostdlib -Bdynamic -Wl,-T,build/core/armelf.x \
    -Wl,-dynamic-linker,/system/bin/linker -Wl,--gc-sections \
    -Wl,-z,nocopyreloc -Wl,--no-undefined
addvar LIBS -Lout/target/product/generic/obj/lib \
    -Wl,-rpath-link=out/target/product/generic/obj/lib \
    -lc \
...
addvar LDFLAGS out/target/product/generic/obj/lib/crtbegin_dynamic.o
