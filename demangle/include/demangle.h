...
/*
 * If the name cannot be demangled, then NULL will be returned. If the
 * name can be demangled, then the value returned will be a value
 * allocated by strdup, and must be freed by the caller.
 */
char* demangle_c(const char* name);
