...
class Demangler {
 ...
 private:
  ...
  typedef const char* (*parse_func_type)(Demangler*, const char*);
  ...
  static const char* ParseComplexString(Demangler* demangler, const char* name);
  static const char* ParseComplexArgument(Demangler* demangler, const char* name);
  static const char* ParseArguments(Demangler* demangler, const char* name);
  static const char* ParseTemplateArguments(Demangler* demangler, const char* name);
  static const char* ParseTemplateArgumentsComplex(Demangler* demangler, const char* name);
  static const char* ParseFunctionArgument(Demangler* demangler, const char* name);
  static const char* FindFunctionName(Demangler* demangler, const char* name);
  static const char* ParseFunctionName(Demangler* demangler, const char* name);
  static const char* Fail(Demangler*, const char*) { return nullptr; }
