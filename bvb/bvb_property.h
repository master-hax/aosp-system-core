...
#ifndef _BVB_PROPERTY_H
#define _BVB_PROPERTY_H
 ...
 * 64-bit integer. Both decimal and hexidecimal representations are
 * supported. Returns 0 on failure and non-zero on success. On
 * success, the parsed value is returned in |out_value|.
 */
