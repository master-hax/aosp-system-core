 ...
 * use the same mutex for a given Condition.  Note that wait() may
 * spuriously wake up, so you cannot rely on being woken alone; you
 * must check the state of your program as well.
 */
class Condition {
public:
    enum {
