...
public:
     ...
     * with this FD. This is to be used when there is a kernel bug where the
     * kernel does not properly mark itself as having new data available, in
     * order to force "fd_op->poll()" to be called.
     *
