...
// This again makes them attractive for use as keys. However, this is only valid
// if a wp<T> is compared to a wp<T>.
...
template<template<typename C> typename comparator, typename T, typename U>
