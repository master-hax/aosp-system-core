...
#if !defined(LIBUTILS_CALLSTACK_ENABLED)
#if defined(__linux__)
// CallStack is only supported on linux type platforms.
#define LIBUTILS_CALLSTACK_ENABLED 1
#else
#define LIBUTILS_CALLSTACK_ENABLED 0
#endif  // defined(__linux__)
#endif  // !defined(LIBUTILS_CALLSTACK_ENABLED)

#if LIBUTILS_CALLSTACK_ENABLED
...
#if DEBUG_REFS_CALLSTACK_ENABLED && LIBUTILS_CALLSTACK_ENABLED
