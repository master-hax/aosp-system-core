...
// We need to handle both 32 and 64 bit bitsets, so we use a function template here.
// Sadly, std::function can't be generic, so we generate a vector of std::functions
// using this function.
template <typename T>
