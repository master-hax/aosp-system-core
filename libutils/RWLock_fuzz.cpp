...
static const std::vector<std::function<void(android::RWLock&)>> operations = {
        // Unfortunately for the non-try methods, we need to make sure we actually
        // unlock,
        // otherwise our fuzzer will get stuck very quickly and never get out.
        ...
        [](android::RWLock& lock) -> void { lock.tryWriteLock(); },
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    android::RWLock rwLock = android::RWLock(type, name);
