...
static constexpr bool is_surrogate(char16_t w) {
...
ssize_t utf8_to_utf16_length(const uint8_t* u8str, size_t u8len, bool overreadIsFatal)
{
    ...
    while (in < in_end) {
        ...
        /* invalid leading byte, we produce U+FFFF here and keep going */
    ...
    return (in == in_end && utf16_len < SSIZE_MAX) ? utf16_len : -1;
}
