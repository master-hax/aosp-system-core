...
wasn't actually the direction we'd later take.

The move to toybox started in Marshmallow (or rather in AOSP too late for
Lollipop), and if you look at AOSP master today, dd, grep, and newfs\_msdos
are still BSD and only getevent is left of toolbox.
