 ...
 * in the central directory but is stable for a given zip file. New allocated
 * memory will be assigned to |cookie| and it will contain the value of
 * an opaque cookie which can be used to make one or more calls to Next.
 * All calls to StartIteration must be matched by a call to EndIteration to free
