...
// Take android_init_anonymous_namespace() as functionality reference please.
//
// Starting with v3, NativeBridge has two scenarios: with/without namespace.
...
// Take android_create_namespace() as functionality reference please.
//
// Starting with v3, NativeBridge has two scenarios: with/without namespace.
// Should not use in non-namespace scenario.
...
// Creates a link between namespaces.
// Take android_link_namespaces() as functionality reference please.
//
// Starting with v3, NativeBridge has two scenarios: with/without namespace.
// Should not use in non-namespace scenario.
bool NativeBridgeLinkNamespaces(native_bridge_namespace_t* from,
                                native_bridge_namespace_t* to,
                                const char* shared_libs_sonames);

// Load a shared library with namespace key that is supported by the native bridge.
// Take android_dlopen_ext() as functionality reference (namespace semantic only) please.
//
// Starting with v3, NativeBridge has two scenarios: with/without namespace.
...
struct NativeBridgeCallbacks {
  ...
  // Create a link between two namespaces.
  // Take android_link_namespaces() as functionality reference please.
  //
  // Parameters:
