...
// Won't be called in Android mode in v3.
...
struct NativeBridgeCallbacks {
  ...
  //
  // Note that this callback is deprecated and no longer used starting with native bridge v3
  // Use isPathSupported instead.
