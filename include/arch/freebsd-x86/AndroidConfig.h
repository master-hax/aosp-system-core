...
/*
 * Define if ETIMEDOUT exists, but ETIME does not
 */
#define HAVE_ETIMEDOUT

/*
 * Define if ENODATA does not exist
 */
#define HAVE_NO_ENODATA
...
/*
 * Define if have no __off64_t
 * XXX: on FreeBSD off_t is 64bit type
 */
#define HAVE_NO_OFF64_TYPE
