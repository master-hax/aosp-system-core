 ...
 * E.g: smul<x><y>
 */
#define ARCH_ARM_HAVE_HALFWORD_MULTIPLY 1

/*
 * Define if the processor has the clz instruction
 */
#define ARCH_ARM_HAVE_CLZ 1
 ...
 */
#define ARCH_ARM_HAVE_FAST_INTERWORKING 1
 ...
 * E.g: ldrd/strd
 */
#define ARCH_ARM_HAVE_64BIT_DATA 1

/*
 * Define if the architecture has the preload instruction.
 */
#define ARCH_ARM_HAVE_PLD 1
 ...
 */
#define ARCH_ARM_HAVE_THUMB_SUPPORT 1
