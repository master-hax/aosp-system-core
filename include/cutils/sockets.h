...
/*
 * Initializes socket functionality. No effect on Unix, but on Windows this must
 * be called at least once before attempting to use any socket functionality.
 *
 * All socket creation functions in this library automatically call this.
 */
