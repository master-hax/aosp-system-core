 ...
 *
 * Example usage:
 *   cutils_socket_buffer_t buffers[2] = { cutils_socket_buffer(data0, len0),
 *                                         cutils_socket_buffer(data1, len1) };
 *   socket_send_buffers(sock, buffers, 2);
 *
 * Returns the number of bytes written or -1 on error.
 */
cutils_socket_buffer_t cutils_socket_buffer(void* data, size_t length);
