...
/*
 * NOTE: Since Looper is used to implement the NDK ALooper, these
...
enum {
     ...
     */
    LOOPER_PREPARE_ALLOW_NON_CALLBACKS = 1<<0
};
 ...
 * a bitmask of the poll events that were triggered (typically LOOPER_EVENT_INPUT),
...
public:
     ...
     *
     * Returns LOOPER_POLL_WAKE if the poll was awoken using wake() before
     * the timeout expired and no callbacks were invoked and no other file
     * descriptors were ready.
     *
     * Returns LOOPER_POLL_CALLBACK if one or more callbacks were invoked.
     *
     * Returns LOOPER_POLL_TIMEOUT if there was no data before the given
     * timeout expired.
     *
     * Returns LOOPER_POLL_ERROR if an error occurred.
     *
     ...
     * This function will never return LOOPER_POLL_CALLBACK.
     */
     ...
     * The identifier must be >= 0, or LOOPER_POLL_CALLBACK if providing a non-NULL callback.
     * "events" are the poll events to wake up on.  Typically this is LOOPER_EVENT_INPUT.
     ...
     *
     * The opts may be LOOPER_PREPARE_ALLOW_NON_CALLBACKS or 0.
     */
