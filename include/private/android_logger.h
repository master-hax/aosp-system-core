...
#ifdef __cplusplus
#ifdef __class_android_log_event_context_defined
#ifndef __class_android_log_event_context_private_defined
#define __class_android_log_event_context_private_defined
/* android_log_context C++ helpers */
extern "C++" {
class __android_log_event_context : public android_log_event_context {
    __android_log_event_context(const android_log_event_context&) = delete;
    void operator =(const __android_log_event_context&) = delete;

public:
    explicit __android_log_event_context(int tag) : android_log_event_context(tag) { }
    explicit __android_log_event_context(log_msg& log_msg) : android_log_event_context(log_msg) { }
