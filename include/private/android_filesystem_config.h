...
static const struct fs_path_config android_files[] = {
    ...
    { 00755, AID_ROOT,      AID_ROOT,      0, "data/nativebenchmark/*" },
    { 00755, AID_ROOT,      AID_ROOT,      0, "data/nativetest/*" },
    { 00755, AID_ROOT,      AID_ROOT,      0, "data/nativetest_unbundled/*" },
    { 00644, AID_SYSTEM,    AID_SYSTEM,    0, "data/app/*" },
    { 00644, AID_SHELL,     AID_SHELL,     0, "data/local/*" },
