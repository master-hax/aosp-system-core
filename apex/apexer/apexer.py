...
"""
apexer is a command line tool for creating an APEX file, a new package format
for system components.

Typical usage: apexer --manifest manifest.json input_dir output.apex
...
- signing (not clear whether it should be done by apexer)
"""
