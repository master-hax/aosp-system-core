...
public:
    class RegisterFile;
                    ...
                    explicit RegisterAllocator(int arch);
    ...
    {
    public:
                            explicit RegisterFile(int arch);
...
public:
    ...
    int         scanline_core(const needs_t& needs, context_t const* c);
        ...
        struct integer_t : public reg_t {
            ...
            explicit integer_t(int r, int sz=32, int f=0)
                : reg_t(r, f), s(sz) {
            }
        ...
        struct component_t : public reg_t {
            ...
            explicit component_t(int r, int f=0)
                : reg_t(r, f), h(0), l(0) {
            }
