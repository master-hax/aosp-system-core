...
#elif defined(__mips__) && !defined(__LP64__) && !defined(_MIPS_ARCH_MIPS32R6)
...
#if defined(__arm__) || (defined(__mips__) && !defined(__LP64__) && !defined(_MIPS_ARCH_MIPS32R6)) || defined(__aarch64__)
...
#if defined( __mips__) && !defined(__LP64__) && !defined(_MIPS_ARCH_MIPS32R6)
...
{
#if ((ANDROID_CODEGEN >= ANDROID_CODEGEN_ASM) && (defined(__arm__) || (defined(__mips__) && !defined(__LP64__) && !defined(_MIPS_ARCH_MIPS32R6)) || defined(__aarch64__)))
    int32_t x = c->iterators.xl;
    size_t ct = c->iterators.xr - x;
    int32_t y = c->iterators.y;
    surface_t* cb = &(c->state.buffers.color);
