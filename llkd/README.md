...
of the main loop, or spun off as a thread should that be necessary.

The 'C' interface to libllkd.cpp is thus:
...
maintained drivers).  Then the blacklists can be adjusted accordingly if these
conditions are met.
