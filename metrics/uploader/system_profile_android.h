...
#ifndef METRICS_UPLOADER_SYSTEM_PROFILE_ANDROID_H_
#define METRICS_UPLOADER_SYSTEM_PROFILE_ANDROID_H_
...
#include "system/core/metrics/uploader/proto/system_profile.pb.h"
...
class SystemProfileAndroid : public SystemProfileSetter {
 public:
  SystemProfileAndroid();

  SystemProfileAndroid(bool testing, const std::string& config_root);
...
#endif  // METRICS_UPLOADER_SYSTEM_PROFILE_ANDROID_H_
