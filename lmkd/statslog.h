...
static inline bool statslog_enabled() { return false; }
...
stats_write_lmk_kill_occurred(int32_t code __unused, int32_t uid __unused,
                              char const* process_name __unused, int32_t oom_score __unused, int32_t min_oom_score __unused,
                              int tasksize __unused, struct memory_stat *mem_st __unused) { return -EINVAL; }
