...
__attribute__((always_inline)) enum lmk_cmd lmkd_pack_get_cmd(LMKD_CTRL_PACKET pack) {
 ...
 */
__attribute__((always_inline)) void lmkd_pack_get_target(LMKD_CTRL_PACKET packet, int target_idx,
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) size_t lmkd_pack_set_target(LMKD_CTRL_PACKET packet,
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) void lmkd_pack_get_procprio(LMKD_CTRL_PACKET packet,
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) size_t lmkd_pack_set_procprio(LMKD_CTRL_PACKET packet,
                                                             struct lmk_procprio* params) {
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) void lmkd_pack_get_procremove(LMKD_CTRL_PACKET packet,
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) size_t lmkd_pack_set_procremove(LMKD_CTRL_PACKET packet,
                                                               struct lmk_procprio* params) {
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) size_t lmkd_pack_set_procpurge(LMKD_CTRL_PACKET packet) {
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) void lmkd_pack_get_getkillcnt(LMKD_CTRL_PACKET packet,
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) size_t lmkd_pack_set_getkillcnt(LMKD_CTRL_PACKET packet,
                                                               struct lmk_getkillcnt* params) {
 ...
 * Warning: no checks performed, caller should ensure valid parameters.
 */
__attribute__((always_inline)) size_t lmkd_pack_set_getkillcnt_repl(LMKD_CTRL_PACKET packet,
                                                                    int kill_cnt) {
    packet[0] = htonl(LMK_GETKILLCNT);
