...
static const char *event_test_1(uint32_t tag, size_t &expected_len) {
...
static const char *event_test_2(uint32_t tag, size_t &expected_len) {
    android_log_context ctx;
...
static const char *event_test_3(uint32_t tag, size_t &expected_len) {
    android_log_context ctx;
    ...
    expected_len = sizeof(uint32_t) + 77;

    return "[[16909060,72623859790382856,Hello World,[1,2,3,4],1.010203],dlroW olleH]";
}

static const char *event_test_4(uint32_t tag, size_t &expected_len) {
    android_log_context ctx;
...
static const char *event_test_5(uint32_t tag, size_t &expected_len) {
    android_log_context ctx;
...
TEST(liblog, create_android_logger_1) {
    create_android_logger(event_test_1);
}

TEST(liblog, create_android_logger_2) {
    create_android_logger(event_test_2);
}

TEST(liblog, create_android_logger_3) {
    create_android_logger(event_test_3);
}

TEST(liblog, create_android_logger_4) {
    create_android_logger(event_test_4);
}

TEST(liblog, create_android_logger_5) {
    create_android_logger(event_test_5);
}
