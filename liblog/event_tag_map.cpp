...
public:
    ...
    MapString(const char* str, size_t len) : str(str, len) { }
    MapString(MapString &&rval) : str(rval.data(), rval.length()) { }
    explicit MapString(const MapString &rval) : str(rval.data(), rval.length()) { }
};
