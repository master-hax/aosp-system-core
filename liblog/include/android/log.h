 ...
 */
void __android_log_write_log_message(struct __android_log_message* log_message, const char* message)
    __INTRODUCED_IN(30);
 ...
 * Available since API level 30.
 */
void __android_log_logd_logger(const struct __android_log_message* log_message, const char* message)
    __INTRODUCED_IN(30);
