 ...
 */
typedef void (*__android_aborter_function)(const char* abort_message) __attribute__((noreturn));
 ...
 * user defined aborter function must abort and is therefore marked as noreturn.
 *
 ...
 * Available since API level 30.
 */
void __android_log_call_aborter(const char* abort_message) __attribute__((noreturn))
__INTRODUCED_IN(30);
