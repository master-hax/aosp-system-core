...
/**
 * Writes the log message to logd.  This is the default logger when running liblog on device.
 */
void __android_log_logd_logger(const struct __android_logger_data* logger_data, const char* msg);

/**
 * Writes the log message to stderr.  This is the default logger when running liblog on host.
 */
