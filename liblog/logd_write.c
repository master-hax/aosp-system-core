...
__ABI_PUBLIC__ int __android_log_dev_available(void)
{
...
__ABI_PUBLIC__ int __android_log_write(int prio, const char *tag,
                                       const char *msg)
{
    return __android_log_buf_write(LOG_ID_MAIN, prio, tag, msg);
}

__ABI_PUBLIC__ int __android_log_buf_write(int bufID, int prio,
...
__ABI_PUBLIC__ int __android_log_vprint(int prio, const char *tag,
...
__ABI_PUBLIC__ int __android_log_print(int prio, const char *tag,
                                       const char *fmt, ...)
{
    va_list ap;
    char buf[LOG_BUF_SIZE];
...
__ABI_PUBLIC__ int __android_log_buf_print(int bufID, int prio,
                                           const char *tag,
                                           const char *fmt, ...)
{
    va_list ap;
...
__ABI_PUBLIC__ void __android_log_assert(const char *cond, const char *tag,
                                         const char *fmt, ...)
{
    char buf[LOG_BUF_SIZE];
...
__ABI_PUBLIC__ int __android_log_bwrite(int32_t tag,
...
__ABI_PUBLIC__ int __android_log_security_bwrite(int32_t tag,
                                                 const void *payload,
                                                 size_t len)
{
    struct iovec vec[2];
 ...
 */
__ABI_PUBLIC__ int __android_log_btwrite(int32_t tag, char type,
                                         const void *payload, size_t len)
{
    struct iovec vec[3];
 ...
 * event log.
 */
__ABI_PUBLIC__ int __android_log_bswrite(int32_t tag, const char *payload)
{
    struct iovec vec[4];
 ...
 * security log.
 */
__ABI_PUBLIC__ int __android_log_security_bswrite(int32_t tag,
                                                  const char *payload)
{
    struct iovec vec[4];
    char type = EVENT_TYPE_STRING;
