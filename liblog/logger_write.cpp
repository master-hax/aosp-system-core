...
void __android_log_stderr_logger(const struct __android_log_message* log_message,
  ...
  if (log_message->file != nullptr) {
    fprintf(stderr, "%s %c %s %5d %5" PRIu64 " %s:%u] %s\n",
            ...
            tid, log_message->file, log_message->line, message);
  } else {
...
void __android_log_write_log_message(__android_log_message* log_message, const char* message) {
  ...
  logger_function(log_message, message);
}
...
int __android_log_buf_write(int bufID, int prio, const char* tag, const char* msg) {
  ...
  __android_log_message log_message = {sizeof(__android_log_message), bufID, prio, tag, nullptr, 0};
  __android_log_write_log_message(&log_message, msg);
  return 1;
}
...
int __android_log_vprint(int prio, const char* tag, const char* fmt, va_list ap) {
  ...
  __android_log_message log_message = {
      sizeof(__android_log_message), LOG_ID_MAIN, prio, tag, nullptr, 0};
  __android_log_write_log_message(&log_message, buf);
  return 1;
}
