...
TEST(FastBoot, ParseRequirementLineMalformed) {
    ...
    // Disallow empty options, double ||, etc.
    ParseRequirementLineTestMalformed("require product=alpha||beta|   |gamma");
    ParseRequirementLineTestMalformed("require product=alpha||beta|gamma");
    ParseRequirementLineTestMalformed("require product=alpha|beta|   |gamma");
    ParseRequirementLineTestMalformed("require product=alpha||");
    ParseRequirementLineTestMalformed("require product=alpha|| ");
    ParseRequirementLineTestMalformed("require product=alpha| ");
    ParseRequirementLineTestMalformed("require product=alpha|beta| ");
}
