...
LOCAL_SRC_FILES_linux := socket_linux_osx.cpp usb_linux.cpp util_linux.cpp
LOCAL_STATIC_LIBRARIES_linux := libcutils libselinux

LOCAL_SRC_FILES_darwin := socket_linux_osx.cpp usb_osx.cpp util_osx.cpp
...
LOCAL_SRC_FILES_linux := socket_linux_osx.cpp
LOCAL_STATIC_LIBRARIES_linux := libcutils

LOCAL_SRC_FILES_darwin := socket_linux_osx.cpp
LOCAL_LDLIBS_darwin := -lpthread -framework CoreFoundation -framework IOKit -framework Carbon
LOCAL_CFLAGS_darwin := -Wno-unused-parameter
