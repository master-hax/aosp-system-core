...
class FastbootDevice {
  public:
    ...
    android::sp<android::hardware::boot::V1_0::IBootControl> boot_control_module() {
        return boot_control_module_;
    }
  ...
  private:
    ...
    android::sp<android::hardware::boot::V1_0::IBootControl> boot_control_module_;
