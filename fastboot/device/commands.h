...
using command_handler = std::function<void(FastbootDevice*, const std::vector<std::string>&,
                                           status_cb_t, data_cb_t)>;
...
void SetActiveHandler(FastbootDevice* device, const std::vector<std::string>& args,
                      status_cb_t status_cb);
void ShutDownHandler(FastbootDevice* device, status_cb_t status_cb);
void RebootHandler(FastbootDevice* device, status_cb_t status_cb);
void RebootBootloaderHandler(FastbootDevice* device, status_cb_t status_cb);
void RebootFastbootHandler(FastbootDevice* device, status_cb_t status_cb);
void RebootRecoveryHandler(FastbootDevice* device, status_cb_t status_cb);
