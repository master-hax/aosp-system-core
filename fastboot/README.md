...
build artifact.  This build artifact will live inside of
ANDROID_PRODUCT_OUT && target_files_package && updatepackage.
...
The currently defined commands are:
    ...
    erase              erase given partition (can only be used in conjunction)
