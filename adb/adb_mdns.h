...
const char* kADBSecurePairingServiceTxtRecord = ADB_SECURE_SERVICE_VERSION_TXT_RECORD(1);
const char* kADBSecureConnectServiceTxtRecord = ADB_SECURE_SERVICE_VERSION_TXT_RECORD(1);
