...
struct AdbMdnsResponderFuncs {
    ...
    std::optional<MdnsInfo> (*_Nonnull mdns_get_connect_service_info)(std::string_view);
    std::optional<MdnsInfo> (*_Nonnull mdns_get_pairing_service_info)(std::string_view);
    void (*_Nonnull mdns_cleanup)(void);
    bool (*_Nonnull adb_secure_connect_by_service_name)(std::string_view);
};  // AdbBonjourCallbacks
