...
void help()
{
    ...
    fprintf(stderr,
        ...
        "  adb reboot [-a] sideload     - reboots the device into the sideload mode in recovery program (adb root required).\n"
        "                                  ('-a' to reboot automatically after the sideload regardless of the installation result)\n"
    ...
    if (!strcmp(argv[0], "devices")) {
        ...
        if (argc == 1) {
            ...
            snprintf(command, sizeof(command), "reboot:%s", argv[1]);
                   ...
                   ((!strcmp(argv[1], "sideload") && !strcmp(argv[2], "-a")) ||
                   (!strcmp(argv[1], "-a") && !strcmp(argv[2], "sideload")))) {
            snprintf(command, sizeof(command), "reboot:sideload-a");
        } else {
