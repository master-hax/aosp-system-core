...
def make_random_device_files(device, in_dir, num_files):
    ...
    for file_num in xrange(num_files):
        ...
        dev_md5, _ = device.shell(['md5sum', full_path]).split()
...
class FileOperationsTest(DeviceTest):
    ...
    def _test_push(self, local_file, checksum):
        ...
        try:
            ...
            dev_md5, _ = self.device.shell(
                ['md5sum', self.DEVICE_TEMP_FILE]).split()
    ...
    def test_sync(self):
        ...
        try:
            ...
            device = adb.AndroidDevice(out_dir=base_dir)
            ...
            for temp_file in temp_files:
                ...
                dev_md5, _ = device.shell(['md5sum', device_full_path]).split()
