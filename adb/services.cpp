...
static void service_bootstrap_func(std::string service_name,
...
static bool reboot_service_impl(android::base::unique_fd fd, const std::string& arg) {
...
static void reconnect_service(android::base::unique_fd fd, atransport* t) {
...
static android::base::unique_fd create_service_thread(
        const char* service_name, std::function<void(android::base::unique_fd)> func) {
    int s[2];
    if (adb_socketpair(s)) {
