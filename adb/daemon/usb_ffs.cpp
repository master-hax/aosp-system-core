...
usb_os_desc_guid_t os_desc_guid = {
    ...
    // Randomly generated UUIDv4, with the first 32-bits hand-modified.
    // 90 bits of entropy ought to be enough for anybody.
    .bProperty = "{00000ADB-CA90-42A2-A11A-8C52E2D5D724}",
};
