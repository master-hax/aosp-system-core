...
int execCmd(std::string_view args, int in, int out, int err) {
...
int main(int argc, char* const argv[]) {
    ...
    // adbd uses SIGHUP to indicate that something is broken on its side
    ...
    while (true) {
        ...
        auto result = StartCommandInProcess(data.data(), &execCmd);
