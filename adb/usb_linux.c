            ...
            while (bufptr < bufend) {
                ...
                if (type == USB_DT_INTERFACE) {
                    ...
                    if (interface->bNumEndpoints == 2 &&
                        ...
                        // For USB 3.0, SuperSpeed devices skip potential USB 3.0 SuperSpeed Companion descriptor
                        if (bufptr+2 <= devdesc + desclength && bufptr[0] == USB_DT_SS_EP_COMP_SIZE && bufptr[1] == USB_DT_SS_ENDPOINT_COMP) {
