...
static void DNSSD_API on_service_browsed(DNSServiceRef sdRef,
    ...
    if (flags & kDNSServiceFlagsAdd) {
        D("%s: Discover found new serviceName=[%s] regtype=[%s] domain=[%s]", __func__,
        ...
        D("%s: Discover lost serviceName=[%s] regtype=[%s] domain=[%s]", __func__,
          serviceName, regtype, domain);
