...
#include "client/mdns_service_info.h"

using namespace openscreen;

namespace mdns {

using ServicesUpdatedState = discovery::DnsSdServiceWatcher<ServiceInfo>::ServicesUpdatedState;
...
std::string ServiceReceiver::GetServiceName() const {
