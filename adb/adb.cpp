...
void start_device_log(void) {
    ...
    // TODO(danalbert): Add a sequence number to the file name.
    // If adbd crashes and restarts in the same second, we'll clobber the log
    // that might have information about the crash.
    char path[PATH_MAX];
