...
static unsigned __stdcall adb_winthread_wrapper(void* args) {
    adb_winthread_args thread_args = *static_cast<adb_winthread_args*>(args);
    delete static_cast<adb_winthread_args*>(args);
...
static void* adb_pthread_wrapper(void* arg) {
    adb_pthread_args args = *reinterpret_cast<adb_pthread_args*>(arg);
    delete static_cast<adb_pthread_args*>(arg);
    args.func(args.arg);
    return nullptr;
}
