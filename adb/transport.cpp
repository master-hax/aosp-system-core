...
// threads exit, but the read_transport thread will kick the transport
// on its way out to disconnect the underlying device.
//
// read_transport thread reads data from a transport (representing an usb/tcp connection),
// and writes to local sockets in adb/adbd.
...
// write_transport thread reads data from local sockets in adb/adbd,
// and writes to a transport (representing an usb/tcp connection).
