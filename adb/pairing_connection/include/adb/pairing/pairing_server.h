...
typedef void (*pairing_server_result_cb)(const PeerInfo*, void*) __INTRODUCED_IN(__ANDROID_API_R__);
...
void pairing_server_destroy(PairingServerCtx* ctx) __INTRODUCED_IN(__ANDROID_API_R__);
