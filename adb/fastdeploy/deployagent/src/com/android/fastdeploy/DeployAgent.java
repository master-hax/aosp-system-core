...
public final class DeployAgent {
                ...
                if (commandString.equals("extract")) {
                    ...
                    if (args.length < 3) {
                        ...
                        if (dashIndex == packageName.length() - 1) {
                            ...
                            exitCode = applyPatch(
                                packageName.substring(0, dashIndex), deltaInputStream, System.out);
                        } else {
    ...
    private static int applyPatch(
        String packageName, InputStream deltaStream, OutputStream outputStream) throws IOException {
    ...
    private static long writePatchDataToStream(RandomAccessFile oldData, long newSize,
