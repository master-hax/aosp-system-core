...
public final class DeployAgent {
    ...
    private static void showUsage(int exitCode) {
        ...
        System.err.println(
            "-o - by default output will be sent to packagemanager, -o will redirect to stdout");
    ...
    private static long applyPatch(String packageName, InputStream deltaStream,
        ...
        long bytesWritten =
            writePatchToStream(new RandomAccessFile(deviceFile, "r"), deltaStream, outputStream);
        return bytesWritten;
    }
