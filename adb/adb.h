...
// To do this, we need to know when the scan has identified all of potential new transports, and
...
// One or more transport has changed status, check to see if we're ready.
