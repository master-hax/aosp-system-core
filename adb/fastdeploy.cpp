    ...
    while ((code = tree.next()) != ResXMLParser::BAD_DOCUMENT &&
        ...
        switch (code) {
            case ResXMLParser::START_TAG: {
                ...
                android::String16 element_name_string(element_name, element_name_length);

                if (element_name_string.compare(android::String16(u"manifest")) == 0) {
                    for (int i = 0; i < (int)tree.getAttributeCount(); i++) {
                        ...
                        android::String16 attribute_name_string(attribute_name_text,
                                                                attribute_name_length);

                        if (attribute_name_string.compare(android::String16("package")) == 0) {
