...
/* Session descriptor in d */
int keychord_release(int d);

/* event callback function prototype */
typedef void (*keychord_event_handler_fn)(const struct input_event* event, int fd, const char* name);
/*
...
int keychord_enable(int d, int type /* = EV_KEY */, const std::vector<int>& keycodes,
