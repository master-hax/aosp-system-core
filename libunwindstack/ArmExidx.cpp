...
inline bool ArmExidx::DecodePrefix2_3_0000() {
  // 10110000: Finish
  if (log_) {
...
inline bool ArmExidx::DecodePrefix2_3_0001() {
  uint8_t byte;
  if (!GetByte(&byte)) {
    return false;
  }
...
inline bool ArmExidx::DecodePrefix2_3_0010() {
...
inline bool ArmExidx::DecodePrefix2_3_0011() {
...
inline bool ArmExidx::DecodePrefix2_3_01nn() {
  // 101101nn: Spare
  if (log_) {
    log(log_indent_, "Spare");
  }
...
inline bool ArmExidx::DecodePrefix2_3_1nnn(uint8_t byte) {
...
inline bool ArmExidx::DecodePrefix2(uint8_t byte) {
  ...
  default:
    ...
    switch (byte) {
    case 0:
      return DecodePrefix2_3_0000();
    case 1:
      return DecodePrefix2_3_0001();
    case 2:
      return DecodePrefix2_3_0010();
    case 3:
      return DecodePrefix2_3_0011();
    default:
      if (byte & 0x8) {
        return DecodePrefix2_3_1nnn(byte);
      } else {
        return DecodePrefix2_3_01nn();
      }
    }
  }
}
