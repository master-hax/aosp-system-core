...
const DwarfFde* DwarfEhFrameWithHdr<AddressType>::GetFdeFromPc(uint64_t pc) {
  ...
  // There is a possibility that the FDE has no valid pcs associated with
  // it due to a bug. If this happens, try and find the real FDE from
  // the eh_frame data. See b/142483624.
