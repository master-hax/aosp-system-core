...
static Regs* CreateFromX86Ucontext(void* ucontext) {
  ...
  (*regs)[X86_REG_GS] = x86_ucontext->uc_mcontext.regs[0];
  (*regs)[X86_REG_FS] = x86_ucontext->uc_mcontext.regs[1];
  (*regs)[X86_REG_ES] = x86_ucontext->uc_mcontext.regs[2];
  (*regs)[X86_REG_DS] = x86_ucontext->uc_mcontext.regs[3];
  (*regs)[X86_REG_EDI] = x86_ucontext->uc_mcontext.regs[4];
  (*regs)[X86_REG_ESI] = x86_ucontext->uc_mcontext.regs[5];
  (*regs)[X86_REG_EBP] = x86_ucontext->uc_mcontext.regs[6];
  (*regs)[X86_REG_ESP] = x86_ucontext->uc_mcontext.regs[7];
  (*regs)[X86_REG_EBX] = x86_ucontext->uc_mcontext.regs[8];
  (*regs)[X86_REG_EDX] = x86_ucontext->uc_mcontext.regs[9];
  (*regs)[X86_REG_ECX] = x86_ucontext->uc_mcontext.regs[10];
  (*regs)[X86_REG_EAX] = x86_ucontext->uc_mcontext.regs[11];
  (*regs)[X86_REG_EIP] = x86_ucontext->uc_mcontext.regs[14];
  regs->SetFromRaw();
  return regs;
}
...
static Regs* CreateFromX86_64Ucontext(void* ucontext) {
  ...
  // R8-R15
  memcpy(&(*regs)[X86_64_REG_R8], &x86_64_ucontext->uc_mcontext.regs[0], 8 * sizeof(uint64_t));

  // Rest of the registers.
  (*regs)[X86_64_REG_RDI] = x86_64_ucontext->uc_mcontext.regs[8];
  (*regs)[X86_64_REG_RSI] = x86_64_ucontext->uc_mcontext.regs[9];
  (*regs)[X86_64_REG_RBP] = x86_64_ucontext->uc_mcontext.regs[10];
  (*regs)[X86_64_REG_RBX] = x86_64_ucontext->uc_mcontext.regs[11];
  (*regs)[X86_64_REG_RDX] = x86_64_ucontext->uc_mcontext.regs[12];
  (*regs)[X86_64_REG_RAX] = x86_64_ucontext->uc_mcontext.regs[13];
  (*regs)[X86_64_REG_RCX] = x86_64_ucontext->uc_mcontext.regs[14];
  (*regs)[X86_64_REG_RSP] = x86_64_ucontext->uc_mcontext.regs[15];
  (*regs)[X86_64_REG_RIP] = x86_64_ucontext->uc_mcontext.regs[16];
