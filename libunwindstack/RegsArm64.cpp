...
void RegsArm64::set_pc(uint64_t pc) {
  // Directive is here to make sure source compiles for non-aarch64 targets too.
  ...
  // authentication code using xpaclri. xpaclri is a NOP on
...
bool RegsArm64::IsRASigned(void) {
  uint64_t value;
