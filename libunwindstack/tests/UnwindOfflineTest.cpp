...
// The eh_frame_hdr is present but set to zero fdes. This should force
// the usage of the non eh_frame_hdr information. Also, there is
// no .gnu_debugdata in the executable, so no symbols.
...
// The waiter has bad eh_frame unwind information. If eh_frame is used,
// the unwind will not work.
