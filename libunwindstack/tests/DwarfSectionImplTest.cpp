...
TYPED_TEST_P(DwarfSectionImplTest, Eval_register_reference_chain) {
  ...
  EXPECT_EQ(0x13U, regs[2]);
  EXPECT_EQ(0x16U, regs[3]);
  EXPECT_EQ(0x1aU, regs[4]);
  EXPECT_EQ(0x1fU, regs[5]);
...
REGISTER_TYPED_TEST_CASE_P(
    ...
    Eval_register_reference_chain, Eval_invalid_register, Eval_different_reg_locations,
