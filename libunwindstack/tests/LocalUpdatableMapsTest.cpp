...
TEST_F(LocalUpdatableMapsTest, add_map_prev_name_dangling_ptr) {
  TemporaryFile tf;
  ASSERT_TRUE(
      android::base::WriteStringToFile("3000-4000 rwxp 00000 00:00 0\n"
                                       "8000-9000 r-xp 00000 00:00 0\n"
...
TEST_F(LocalUpdatableMapsTest, add_map_prev_real_name_dangling_ptr) {
  TemporaryFile tf;
  ASSERT_TRUE(
      android::base::WriteStringToFile("3000-4000 r-xp 00000 00:00 0 /fake/lib.so\n"
                                       "3000-4000 ---p 00000 00:00 0\n"
                                       "8000-9000 r-xp 00000 00:00 0 /fake/lib.so\n"
  ...
  ASSERT_TRUE(
      android::base::WriteStringToFile("3000-4000 r-xp 00000 00:00 0 /fake/lib.so\n"
                                       ...
                                       "8000-9000 r-xp 00000 00:00 0 /fake/lib.so\n"
                                       "8000-9000 ---p 00000 00:00 0\n"
                                       "9000-a000 r-xp 00000 00:00 0 /fake/lib.so\n"
                                       "a000-b000 r-xp 00000 00:00 0 /fake/lib.so\n",
                                       tf.path));
