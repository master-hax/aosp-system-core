...
TEST_F(RegsTest, elf_invalid) {
  ...
  ASSERT_EQ(0x900U, invalid_elf.GetRelPc(regs_mips.pc(), &map_info));
  ASSERT_EQ(0x900U, regs_mips.GetAdjustedPc(0x900U, &invalid_elf));

  regs_mips64.set_pc(0x1a00);
  ASSERT_EQ(0xa00U, invalid_elf.GetRelPc(regs_mips64.pc(), &map_info));
  ASSERT_EQ(0xa00U, regs_mips64.GetAdjustedPc(0xa00U, &invalid_elf));
}
