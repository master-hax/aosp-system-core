...
class ElfFake : public Elf {
 public:
  ...
  void set_elf_interface(ElfInterfaceBase* interface) { interface_.reset(interface); }
};

class ElfInterfaceFake : public ElfInterfaceBase {
 public:
  ElfInterfaceFake(Memory* memory) : ElfInterfaceBase(memory) {}
