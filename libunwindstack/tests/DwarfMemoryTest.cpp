...
class DwarfMemoryTest : public ::testing::Test {
 protected:
  ...
  void GetEncodedSize_absptr();
  template <typename AddressType>
  void GetEncodedSize_data1();
  template <typename AddressType>
  void GetEncodedSize_data2();
  template <typename AddressType>
  void GetEncodedSize_data4();
  template <typename AddressType>
  void GetEncodedSize_data8();
  template <typename AddressType>
  void GetEncodedSize_unknown();
  template <typename AddressType>
...
TEST_F(DwarfMemoryTest, GetEncodedSize_absptr_uint32_t) { GetEncodedSize_absptr<uint32_t>(); }

TEST_F(DwarfMemoryTest, GetEncodedSize_absptr_uint64_t) { GetEncodedSize_absptr<uint64_t>(); }
...
TEST_F(DwarfMemoryTest, GetEncodedSize_data1_uint32_t) { GetEncodedSize_data1<uint32_t>(); }

TEST_F(DwarfMemoryTest, GetEncodedSize_data1_uint64_t) { GetEncodedSize_data1<uint64_t>(); }
...
TEST_F(DwarfMemoryTest, GetEncodedSize_data2_uint32_t) { GetEncodedSize_data2<uint32_t>(); }

TEST_F(DwarfMemoryTest, GetEncodedSize_data2_uint64_t) { GetEncodedSize_data2<uint64_t>(); }
...
TEST_F(DwarfMemoryTest, GetEncodedSize_data4_uint32_t) { GetEncodedSize_data4<uint32_t>(); }

TEST_F(DwarfMemoryTest, GetEncodedSize_data4_uint64_t) { GetEncodedSize_data4<uint64_t>(); }
...
TEST_F(DwarfMemoryTest, GetEncodedSize_data8_uint32_t) { GetEncodedSize_data8<uint32_t>(); }

TEST_F(DwarfMemoryTest, GetEncodedSize_data8_uint64_t) { GetEncodedSize_data8<uint64_t>(); }
...
TEST_F(DwarfMemoryTest, GetEncodedSize_unknown_uint32_t) { GetEncodedSize_unknown<uint32_t>(); }

TEST_F(DwarfMemoryTest, GetEncodedSize_unknown_uint64_t) { GetEncodedSize_unknown<uint64_t>(); }
