...
class RegsFake : public Regs {
 public:
  ...
  Elf::TypeEnum Type() override { return fake_type_; }
  ...
  void FakeSetType(Elf::TypeEnum type) { fake_type_ = type; }
 ...
 private:
  Elf::TypeEnum fake_type_ = Elf::UNKNOWN;
  uint64_t fake_pc_ = 0;
  uint64_t fake_sp_ = 0;
...
class RegsImplFake : public RegsImpl<TypeParam> {
 public:
  ...
  Elf::TypeEnum Type() override { return Elf::UNKNOWN; }
