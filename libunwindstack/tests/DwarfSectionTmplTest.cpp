...
class MockDwarfSectionTmpl : public DwarfSectionTmpl<TypeParam> {
 public:
  MockDwarfSectionTmpl(Memory* memory) : DwarfSectionTmpl<TypeParam>(memory) {}
  virtual ~MockDwarfSectionTmpl() = default;
...
template <typename TypeParam>
class DwarfSectionTmplTest : public ::testing::Test {
 protected:
  void SetUp() override {
    memory_.Clear();
    section_ = new MockDwarfSectionTmpl<TypeParam>(&memory_);
    ResetLogs();
  }
  ...
  MemoryFake memory_;
  MockDwarfSectionTmpl<TypeParam>* section_ = nullptr;
};
TYPED_TEST_CASE_P(DwarfSectionTmplTest);

// NOTE: All test class variables need to be referenced as this->.

TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_expr_eval_fail) {
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_expr_no_stack) {
  DwarfCIE cie{.version = 3, .return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_expr) {
  DwarfCIE cie{.version = 3, .return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_val_expr) {
  DwarfCIE cie{.version = 3, .return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_expr_is_register) {
  DwarfCIE cie{.version = 3, .return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_bad_regs) {
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_no_cfa) {
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_bad) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_register_prev) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_cfa_register_from_value) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_double_indirection) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_invalid_register) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_different_reg_locations) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_return_address_undefined) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_return_address) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_ignore_large_reg_loc) {
  DwarfCIE cie{.return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_reg_expr) {
  DwarfCIE cie{.version = 3, .return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_reg_val_expr) {
  DwarfCIE cie{.version = 3, .return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, Eval_same_cfa_same_pc) {
  DwarfCIE cie{.version = 3, .return_address_register = 5};
  RegsFake<TypeParam> regs(10, 9);
  dwarf_loc_regs_t loc_regs;
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCIE_fail_should_not_cache) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCIE_32_version_check) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCIE_negative_data_alignment_factor) {
  this->memory_.SetData32(0x5000, 0x100);
  this->memory_.SetData32(0x5004, 0xffffffff);
  this->memory_.SetData8(0x5008, 0x1);
  this->memory_.SetData8(0x5009, '\0');
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCIE_64_no_augment) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCIE_augment) {
  this->memory_.SetData32(0x5000, 0x100);
  this->memory_.SetData32(0x5004, 0xffffffff);
  this->memory_.SetData8(0x5008, 0x1);
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCIE_version_3) {
  this->memory_.SetData32(0x5000, 0x100);
  this->memory_.SetData32(0x5004, 0xffffffff);
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCIE_version_4) {
  this->memory_.SetData32(0x5000, 0x100);
  this->memory_.SetData32(0x5004, 0xffffffff);
...
TYPED_TEST_P(DwarfSectionTmplTest, GetFDEFromOffset_fail_should_not_cache) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetFDEFromOffset_32_no_augment) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetFDEFromOffset_32_no_augment_non_zero_segment_size) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetFDEFromOffset_32_augment) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetFDEFromOffset_64_no_augment) {
...
TYPED_TEST_P(DwarfSectionTmplTest, GetFDEFromOffset_cached) {
  DwarfCIE cie{};
  cie.fde_address_encoding = DW_EH_PE_udata4;
  cie.augmentation_string.push_back('z');
  cie.lsda_encoding = DW_EH_PE_udata2;
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCfaLocationInfo_cie_not_cached) {
  DwarfCIE cie{};
...
TYPED_TEST_P(DwarfSectionTmplTest, GetCfaLocationInfo_cie_cached) {
  DwarfCIE cie{};
  cie.cfa_instructions_offset = 0x3000;
  cie.cfa_instructions_end = 0x3002;
  DwarfFDE fde{};
...
TYPED_TEST_P(DwarfSectionTmplTest, Log) {
  DwarfCIE cie{};
...
REGISTER_TYPED_TEST_CASE_P(
    DwarfSectionTmplTest, Eval_cfa_expr_eval_fail, Eval_cfa_expr_no_stack,
...
typedef ::testing::Types<uint32_t, uint64_t> DwarfSectionTmplTestTypes;
INSTANTIATE_TYPED_TEST_CASE_P(, DwarfSectionTmplTest, DwarfSectionTmplTestTypes);
