...
static void VerifyParseLine(std::string line, MapInfo* info) {
  BufferMaps maps(line);
...
TEST(MapsTest, verify_parse_line) {
  ...
  VerifyLine("01-02 rwx- 03 04:05 06\n", &info);
  ...
  VerifyLine("00-00 rwxy 00 00:00 0 /fake\n", nullptr);
  VerifyLine("0\n", nullptr);
  VerifyLine("00\n", nullptr);
  VerifyLine("00-\n", nullptr);
  VerifyLine("00-0\n", nullptr);
  ...
  VerifyLine("00-00 ---- 0\n", nullptr);
  VerifyLine("00-00 ---- 0 \n", nullptr);
  VerifyLine("00-00 ---- 0 0\n", nullptr);
  VerifyLine("00-00 ---- 0 0:\n", nullptr);
  VerifyLine("00-00 ---- 0 0:0\n", nullptr);
  VerifyLine("00-00 ---- 0 0:0 \n", nullptr);

  // Special line that caused previous line parser to crash.
