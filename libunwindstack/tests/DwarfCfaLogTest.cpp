...
// NOTE: All class variable references have to be prefefaced with this->.
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_illegal) {
  for (uint8_t i = 0x17; i < 0x3f; i++) {
    ...
    ResetLogs();
    ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x2000, 0x2001));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_nop) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x2000, 0x2001));
  std::string expected = "4 unwind DW_CFA_nop\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_offset) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x2000, 0x2002));
  std::string expected = "4 unwind DW_CFA_offset register(3) 4\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x2100, 0x2103));
  expected = "4 unwind DW_CFA_offset register(3) 132\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_offset_extended) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x500, 0x503));
  std::string expected = "4 unwind DW_CFA_offset_extended register(3) 2\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x1500, 0x1505));
  expected = "4 unwind DW_CFA_offset_extended register(129) 2306\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_offset_extended_sf) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x500, 0x503));
  std::string expected = "4 unwind DW_CFA_offset_extended_sf register(5) 16\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x1500, 0x1505));
  expected = "4 unwind DW_CFA_offset_extended_sf register(134) -1\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_restore) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x2000, 0x2001));
  std::string expected = "4 unwind DW_CFA_restore register(2)\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x3000, 0x3003));
  expected = "4 unwind DW_CFA_offset register(2) 4\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_restore_extended) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x4000, 0x4002));
  std::string expected = "4 unwind DW_CFA_restore_extended register(8)\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x5000, 0x5007));
  expected = "4 unwind DW_CFA_offset_extended register(258) 4\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_set_loc) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x50, 0x51 + sizeof(TypeParam)));
  ...
  ResetLogs();
  this->fde_.start_pc = address + 0x10;
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_advance_loc) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x200, 0x201));
  std::string expected = "4 unwind DW_CFA_advance_loc 4\n"
  ...
  ResetLogs();
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x100, 0x200, 0x201));
  expected = "4 unwind DW_CFA_advance_loc 4\n"
             "4 unwind Raw Data: 0x44\n"
             "4 unwind \n"
             "4 unwind PC 0x2110\n";
  ASSERT_EQ(expected, GetFakeLogPrint());
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_advance_loc1) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x200, 0x202));
  std::string expected = "4 unwind DW_CFA_advance_loc1 4\n"
  ...
  ResetLogs();
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x10, 0x200, 0x202));
  expected = "4 unwind DW_CFA_advance_loc1 4\n"
             "4 unwind Raw Data: 0x02 0x04\n"
             "4 unwind \n"
             "4 unwind PC 0x2014\n";
  ASSERT_EQ(expected, GetFakeLogPrint());
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_advance_loc2) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x600, 0x603));
  std::string expected = "4 unwind DW_CFA_advance_loc2 772\n"
  ...
  ResetLogs();
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x1000, 0x600, 0x603));
  expected = "4 unwind DW_CFA_advance_loc2 772\n"
             "4 unwind Raw Data: 0x03 0x04 0x03\n"
             "4 unwind \n"
             "4 unwind PC 0x3304\n";
  ASSERT_EQ(expected, GetFakeLogPrint());
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_advance_loc4) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x500, 0x505));
  std::string expected = "4 unwind DW_CFA_advance_loc4 16909060\n"
  ...
  ResetLogs();
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x2000, 0x500, 0x505));
  expected = "4 unwind DW_CFA_advance_loc4 16909060\n"
             "4 unwind Raw Data: 0x04 0x04 0x03 0x02 0x01\n"
             "4 unwind \n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_undefined) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0xa00, 0xa02));
  std::string expected = "4 unwind DW_CFA_undefined register(9)\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x1a00, 0x1a03));
  expected = "4 unwind DW_CFA_undefined register(129)\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_same) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x100, 0x102));
  std::string expected = "4 unwind DW_CFA_same_value register(127)\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x2100, 0x2103));
  expected = "4 unwind DW_CFA_same_value register(255)\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_register) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x300, 0x303));
  std::string expected = "4 unwind DW_CFA_register register(2) register(1)\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x4300, 0x4305));
  expected = "4 unwind DW_CFA_register register(255) register(511)\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_state) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x300, 0x301));

  std::string expected = "4 unwind DW_CFA_remember_state\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x4300, 0x4301));

  expected = "4 unwind DW_CFA_restore_state\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_state_cfa_offset_restore) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x3000, 0x3004));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x100, 0x103));

  std::string expected = "4 unwind DW_CFA_def_cfa register(127) 116\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x200, 0x205));

  expected = "4 unwind DW_CFA_def_cfa register(383) 628\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_sf) {
  ...
  std::string expected = "4 unwind DW_CFA_def_cfa_sf register(48) 37\n"
  ...
  expected = "4 unwind DW_CFA_def_cfa_sf register(163) -6\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_register) {
  ...
  std::string expected = "4 unwind DW_CFA_def_cfa_register register(114)\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x200, 0x203));

  expected = "4 unwind DW_CFA_def_cfa_register register(4217)\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_offset) {
  ...
  std::string expected = "4 unwind DW_CFA_def_cfa_offset 89\n"
  ...
  expected = "4 unwind DW_CFA_def_cfa_offset 89\n"
             "4 unwind Raw Data: 0x0e 0x59\n";
  ASSERT_EQ(expected, GetFakeLogPrint());
  ASSERT_EQ("", GetFakeLogBuf());
  ...
  expected = "4 unwind DW_CFA_def_cfa_offset 1364\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_offset_sf) {
  ...
  std::string expected = "4 unwind DW_CFA_def_cfa_offset_sf 35\n"
  ...
  expected = "4 unwind DW_CFA_def_cfa_offset_sf 35\n"
             "4 unwind Raw Data: 0x13 0x23\n";
  ASSERT_EQ(expected, GetFakeLogPrint());
  ASSERT_EQ("", GetFakeLogBuf());
  ...
  expected = "4 unwind DW_CFA_def_cfa_offset_sf -10\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_expression) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x100, 0x106));

  std::string expected = "4 unwind DW_CFA_def_cfa_expression 4\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x200, 0x284));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_expression) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x100, 0x105));
  ...
  this->memory_.SetMemory(0x200, ops);
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x200, 0x287));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_offset) {
  ...
  std::string expected = "4 unwind DW_CFA_val_offset register(69) 84\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x400, 0x405));

  expected = "4 unwind DW_CFA_val_offset register(290) 692\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_offset_sf) {
  ...
  std::string expected = "4 unwind DW_CFA_val_offset_sf register(86) 18\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0xa00, 0xa05));

  expected = "4 unwind DW_CFA_val_offset_sf register(255) -64\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_expression) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0xa00, 0xaad));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_gnu_args_size) {
  ...
  std::string expected = "4 unwind DW_CFA_GNU_args_size 4\n"
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x5000, 0x5004));

  expected = "4 unwind DW_CFA_GNU_args_size 65572\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_gnu_negative_offset_extended) {
  ...
  std::string expected = "4 unwind DW_CFA_GNU_negative_offset_extended register(8) 16\n"
  ...
  expected = "4 unwind DW_CFA_GNU_negative_offset_extended register(257) 255\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_register_override) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0, 0x300, 0x306));
...
REGISTER_TYPED_TEST_CASE_P(DwarfCfaLogTest,
                           cfa_illegal,
                           cfa_nop,
                           cfa_offset,
                           cfa_offset_extended,
