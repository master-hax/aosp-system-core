...
class ElfInterface {
 public:
  ...
  DwarfSection* gnu_debugdata() { return gnu_debugdata_.get(); }
 ...
 protected:
  ...
  std::unique_ptr<DwarfSection> gnu_debugdata_;
...
class ElfInterface32 : public ElfInterface {
 public:
  ...
  void InitHeaders() override {
    ElfInterface::InitHeadersWithTemplate<uint32_t>();
  }
...
class ElfInterface64 : public ElfInterface {
 public:
  ...
  void InitHeaders() override {
    ElfInterface::InitHeadersWithTemplate<uint64_t>();
  }
