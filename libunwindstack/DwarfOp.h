...
class DwarfOp {
 ...
 private:
  ...
  static bool op_push(void*);
  static bool op_dup(void*);
  static bool op_drop(void*);
  static bool op_over(void*);
  static bool op_pick(void*);
  static bool op_swap(void*);
