...
class JitDebug {
 public:
  ...
  // Verify that entry is still in memory when it is retrieved from the cache.
  void CheckCachedEntries(bool enable) { check_cached_entries = enable; }

 protected:
  bool check_cached_entries = true;
};
