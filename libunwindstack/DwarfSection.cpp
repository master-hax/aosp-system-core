...
bool DwarfSectionTmpl<AddressType>::Eval(const DwarfCIE* cie, Memory* regular_memory,
  ...
  // Since I have not encountered any encodings like this, it's not worth
  // trying to support this particular case.
...
bool DwarfSectionTmpl<AddressType>::GetCfaLocationInfo(uint64_t pc, const DwarfFDE* fde,
  ...
  return cfa.GetLocationInfo(pc, fde->cfa_instructions_offset, fde->cfa_instructions_end, loc_regs);
}
