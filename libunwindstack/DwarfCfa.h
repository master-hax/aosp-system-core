...
typedef bool (*CallbackType)(void*, dwarf_loc_regs_t*);
...
class DwarfCfa {
 ...
 private:
  ...
  static bool cfa_set_loc(void*, dwarf_loc_regs_t*);
  static bool cfa_advance_loc(void* ptr, dwarf_loc_regs_t*);
  static bool cfa_offset(void*, dwarf_loc_regs_t*);
  static bool cfa_restore(void*, dwarf_loc_regs_t*);
  static bool cfa_undefined(void*, dwarf_loc_regs_t*);
  static bool cfa_same_value(void*, dwarf_loc_regs_t*);
  static bool cfa_register(void*, dwarf_loc_regs_t*);
  static bool cfa_remember_state(void*, dwarf_loc_regs_t*);
  static bool cfa_restore_state(void*, dwarf_loc_regs_t*);
  static bool cfa_def_cfa(void*, dwarf_loc_regs_t*);
  static bool cfa_def_cfa_register(void*, dwarf_loc_regs_t*);
  static bool cfa_def_cfa_offset(void*, dwarf_loc_regs_t*);
  static bool cfa_def_cfa_expression(void*, dwarf_loc_regs_t*);
  static bool cfa_expression(void*, dwarf_loc_regs_t*);
  static bool cfa_offset_extended_sf(void*, dwarf_loc_regs_t*);
  static bool cfa_def_cfa_sf(void*, dwarf_loc_regs_t*);
  static bool cfa_def_cfa_offset_sf(void*, dwarf_loc_regs_t*);
  static bool cfa_val_offset(void*, dwarf_loc_regs_t*);
  static bool cfa_val_offset_sf(void*, dwarf_loc_regs_t*);
  static bool cfa_val_expression(void*, dwarf_loc_regs_t*);
  static bool cfa_gnu_negative_offset_extended(void*, dwarf_loc_regs_t*);

  constexpr static CallbackType kCallbackTable[64] = {
    // 0x00 DW_CFA_nop
    cfa_nop,
    // 0x01 DW_CFA_set_loc
    cfa_set_loc,
...
template<typename AddressType> constexpr CallbackType DwarfCfa<AddressType>::kCallbackTable[64];
