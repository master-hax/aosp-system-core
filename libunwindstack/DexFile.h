...
class DexFileFromFile : public DexFile {
 public:
  static DexFileFromFile* Create(uint64_t dex_file_offset_in_file, const std::string& file);
...
class DexFileFromMemory : public DexFile {
 public:
  static DexFileFromMemory* Create(uint64_t dex_file_offset_in_memory, Memory* memory,
