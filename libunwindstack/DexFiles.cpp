...
#if defined(DEXFILE_SUPPORT)
bool DexFiles::GetMethodInformation(Maps* maps, MapInfo* info, uint64_t dex_pc,
...
#else
bool DexFiles::GetMethodInformation(Maps*, MapInfo*, uint64_t, std::string*, uint64_t*) { return false; }
#endif
