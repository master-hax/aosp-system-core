...
bool DwarfCfa<AddressType>::GetLocationInfo(
    uint64_t pc, uint64_t start_offset, uint64_t end_offset, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
std::string DwarfCfa<AddressType>::GetOperandString(
    uint8_t operand, uint64_t value, uint64_t* cur_pc) {
  std::string string;
  switch (operand) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::LogOffsetRegisterString(
    uint32_t indent, uint64_t cfa_offset, uint8_t reg) {
  uint64_t offset;
  if (!memory_->ReadULEB128(&offset)) {
    return false;
  }
...
template <typename AddressType>
bool DwarfCfa<AddressType>::LogInstruction(
    uint32_t indent, uint64_t cfa_offset, uint8_t op, uint64_t* cur_pc) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::Log(
    uint32_t indent, uint64_t pc, uint64_t load_bias, uint64_t start_offset, uint64_t end_offset) {
  memory_->set_cur_offset(start_offset);
  uint64_t cfa_offset;
...
// Static data.
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_nop(DwarfCfa<AddressType>*, dwarf_loc_regs_t*) {
  return true;
}

template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_set_loc(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t*) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_advance_loc(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t*) {
  cfa->cur_pc_ += cfa->operands_[0] * cfa->fde_->cie->code_alignment_factor;
  return true;
}

template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_offset(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_restore(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_undefined(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_same_value(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
  loc_regs->erase(reg);
  return true;
}
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_register(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_remember_state(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  cfa->loc_reg_state_.push(*loc_regs);
  return true;
}

template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_restore_state(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_def_cfa(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_def_cfa_register(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_def_cfa_offset(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_def_cfa_expression(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_expression(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_offset_extended_sf(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_def_cfa_sf(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_def_cfa_offset_sf(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  // Changing the offset if this is not a register is illegal.
  auto cfa_location = loc_regs->find(CFA_REG);
  if (cfa_location == loc_regs->end() || cfa_location->second.type != DWARF_LOCATION_REGISTER) {
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_val_offset(DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
  SignedType offset = static_cast<SignedType>(cfa->operands_[1])
      * cfa->fde_->cie->data_alignment_factor;
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_val_offset_sf(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
  SignedType offset = static_cast<SignedType>(cfa->operands_[1])
      * cfa->fde_->cie->data_alignment_factor;
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_val_expression(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
...
template <typename AddressType>
bool DwarfCfa<AddressType>::cfa_gnu_negative_offset_extended(
    DwarfCfa<AddressType>* cfa, dwarf_loc_regs_t* loc_regs) {
  AddressType reg = cfa->operands_[0];
  SignedType offset = -static_cast<SignedType>(cfa->operands_[1]);
  (*loc_regs)[reg] = { .type = DWARF_LOCATION_OFFSET,
