...
enum NativeBridgeImplementationVersion {
  ...
  // The version replaces initAnonymousNamespace function with
  // initAnonymousNamespace2 and adds new updateNamespaceAddSearchPath function
  // to the native bridge interface
  NAMESPACE_VERSION_APPENDABLE_PATHS = 5,
};
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        // Return dummy pointer in the case when
        // NAMESPACE_VERSION_APPENDABLE_PATHS is not supported.
