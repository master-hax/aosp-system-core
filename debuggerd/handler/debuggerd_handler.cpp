...
static bool is_permissive_mte() {
  ...
  static const char kDeviceConfigProcessPrefix[] =
      "persist.device_config.memory_safety_native.permissive.process.";
  char process_sysprop_name[512];
  async_safe_format_buffer(process_sysprop_name, sizeof(process_sysprop_name), "%s%s",
                           kDeviceConfigProcessPrefix, getprogname());
