...
class DumpMemoryTest : public ::testing::Test {
 protected:
  virtual void SetUp() {
    map_mock_ = new BacktraceMapMock();
    backtrace_mock_ = new BacktraceMock(map_mock_);
  ...
  virtual void TearDown() {
    ...
    delete backtrace_mock_;
    delete map_mock_;
  }

  BacktraceMapMock* map_mock_ = nullptr;
  BacktraceMock* backtrace_mock_ = nullptr;
...
TEST_F(DumpMemoryTest, aligned_addr) {
  ...
  dump_memory(&log_, backtrace_mock_, 0x12345678, "memory near %.2s:", "r1");
...
TEST_F(DumpMemoryTest, partial_read) {
  ...
  dump_memory(&log_, backtrace_mock_, 0x12345679, "memory near %.2s:", "r1");
...
TEST_F(DumpMemoryTest, memory_unreadable) {
  dump_memory(&log_, backtrace_mock_, 0xa2345678, "memory near pc:");
...
TEST_F(DumpMemoryTest, memory_partially_unreadable) {
  ...
  dump_memory(&log_, backtrace_mock_, 0x12345600, "memory near pc:");
...
TEST_F(DumpMemoryTest, address_low_fence) {
  ...
  dump_memory(&log_, backtrace_mock_, 0x1000, "memory near %.2s:", "r1");
...
TEST_F(DumpMemoryTest, memory_address_too_low) {
  ...
  dump_memory(&log_, backtrace_mock_, 0, "memory near %.2s:", "r1");
...
#if defined(__LP64__)
  dump_memory(&log_, backtrace_mock_, 0x4000000000000000UL, "memory near %.2s:", "r1");
  dump_memory(&log_, backtrace_mock_, 0x4000000000000000UL - 32, "memory near %.2s:", "r1");
  dump_memory(&log_, backtrace_mock_, 0x4000000000000000UL - 216, "memory near %.2s:", "r1");
#else
  dump_memory(&log_, backtrace_mock_, 0xffff0000, "memory near %.2s:", "r1");
  dump_memory(&log_, backtrace_mock_, 0xffff0000 - 32, "memory near %.2s:", "r1");
  dump_memory(&log_, backtrace_mock_, 0xffff0000 - 220, "memory near %.2s:", "r1");
#endif
...
#if defined(__LP64__)
  dump_memory(&log_, backtrace_mock_, 0xfffffffffffffff0, "memory near %.2s:", "r1");
#else
  dump_memory(&log_, backtrace_mock_, 0xfffffff0, "memory near %.2s:", "r1");
#endif
...
#if defined(__LP64__)
  dump_memory(&log_, backtrace_mock_, 0x4000000000000000UL - 224, "memory near %.2s:", "r4");
#else
  dump_memory(&log_, backtrace_mock_, 0xffff0000 - 224, "memory near %.2s:", "r4");
#endif
