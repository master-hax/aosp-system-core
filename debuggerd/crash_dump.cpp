...
static NativeBridgeGuestStateHeader* GetGuestStateTlsPointer([[maybe_unused]] pid_t tid) {
#if defined(__x86_64__)
  {
    ...
    auto ptr_to_guest_slot = reinterpret_cast<NativeBridgeGuestStateHeader**>(
        &tp_reg[TLS_SLOT_NATIVE_BRIDGE_GUEST_STATE]);
    uintptr_t header_ptr = ptrace(PTRACE_PEEKDATA, tid, ptr_to_guest_slot, 0);
    return reinterpret_cast<NativeBridgeGuestStateHeader*>(header_ptr);
  }
#else
  return nullptr;
#endif
