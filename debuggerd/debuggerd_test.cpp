...
TEST_F(CrasherTest, mte_multiple_causes) {
  ...
  StartProcess([]() {
    ...
    // Make two allocations with the same tag and close to one another.
    // The out-of-bounds access will be considered either an overflow of one
    // or an underflow of the other.
