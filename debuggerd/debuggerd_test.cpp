...
TEST_F(CrasherTest, smoke) {
  ...
  ASSERT_MATCH(
      result,
      R"(signal 11 \(SIGSEGV\), code 1 \(SEGV_MAPERR\), fault addr 0x000000000000dead, write memory access)");
#else
  ASSERT_MATCH(
      result,
      R"(signal 11 \(SIGSEGV\), code 1 \(SEGV_MAPERR\), fault addr 0x0000dead, write memory access)");
#endif
...
TEST_F(CrasherTest, tagged_fault_addr) {
  ...
  ASSERT_MATCH(
      result,
      R"(signal 11 \(SIGSEGV\), code 1 \(SEGV_MAPERR\), fault addr 0x[01]00000000000dead, write memory access)");
}
...
TEST_F(CrasherTest, LD_PRELOAD) {
  ...
  ASSERT_MATCH(
      result,
      R"(signal 11 \(SIGSEGV\), code 1 \(SEGV_MAPERR\), fault addr 0x0+dead, write memory access)");
}
...
TEST_F(CrasherTest, fault_address_before_first_map) {
  ...
  ASSERT_MATCH(
      result,
      R"(signal 11 \(SIGSEGV\), code 1 \(SEGV_MAPERR\), fault addr 0x0+1024, write memory access)");
...
TEST_F(CrasherTest, describe_read_access) {
  ...
  ASSERT_MATCH(
      result,
      R"(signal 11 \(SIGSEGV\), code 1 \(SEGV_MAPERR\), fault addr 0x0+13337, read memory access)");
}
...
TEST_F(CrasherTest, describe_write_access) {
  ...
  ASSERT_MATCH(
      result,
      R"(signal 11 \(SIGSEGV\), code 1 \(SEGV_MAPERR\), fault addr 0x0+13337, write memory access)");
}
