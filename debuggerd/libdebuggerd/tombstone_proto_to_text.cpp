...
static void print_main_thread(CallbackType callback, const Tombstone& tombstone,
  ...
  if (is_async_mte_crash) {
    ...
    CBL("      in this process, but we do not know exactly where and when it happened.");
    CBL("      The stack trace below is the first system call or context switch that was executed");
    CBL("      after the memory corruption happened.");
  }
