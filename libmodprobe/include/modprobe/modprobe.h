...
class Modprobe {
  public:
    Modprobe(std::vector<std::string>);
    virtual ~Modprobe() = default;

    void HandleUevent(const std::string& modalias);
  ...
  private:
    ...
    bool ParseDepCallback(std::vector<std::string>&& args);
    bool ParseAliasCallback(std::vector<std::string>&& args);
    bool ParseSoftdepCallback(std::vector<std::string>&& args);
    bool ParseLoadCallback(std::vector<std::string>&& args);
    bool ParseOptionsCallback(std::vector<std::string>&& args);
...
typedef bool (Modprobe::*ModprobeParseFn)(std::vector<std::string>&&);
