...
#ifndef SYSTEM_CORE_LIBBINDERWRAPPER_BINDER_WATCHER_H_
#define SYSTEM_CORE_LIBBINDERWRAPPER_BINDER_WATCHER_H_
...
#endif  // SYSTEM_CORE_LIBBINDERWRAPPER_BINDER_WATCHER_H_
