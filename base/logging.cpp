...
void LogMessage::LogLineLowStack(const char* file, unsigned int line, LogId id,
                                 LogSeverity log_severity, const char* message) {
#ifdef __ANDROID__
...
#pragma clang diagnostic ignored "-Wformat-security"
  if (buf != nullptr) {
    ...
    __android_log_buf_print(lg_id, priority, tag, buf);
    free(buf);
  } else {
    __android_log_buf_print(lg_id, priority, tag, message);
  }
