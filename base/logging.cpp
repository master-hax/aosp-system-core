...
void SetLogger(LogFunction&& logger) {
  ...
  if (liblog_functions) {
    ...
    // This leaks memory if multiple instances of libbase within a single process call SetLogger(),
    // but that should be an exceptionally rare case as only the main program should call
    // SetLogger(), never a library.
