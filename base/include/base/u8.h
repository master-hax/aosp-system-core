...
// The functions in the u8 namespace take UTF-8 strings. For Windows, these are
// wrappers, for non-Windows these just expose existing APIs. To call these
// functions, use:
//
// namespace {
...
//     int fd = open(name, ...);  // Calls android::base::u8::open().
//     ...
//   }
// }
namespace u8 {
