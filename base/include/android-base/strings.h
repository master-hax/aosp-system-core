...
std::vector<std::string> Split(const std::string_view& s, const std::string& delimiters);
...
extern template std::string Join(const std::vector<std::string_view>&, char);
extern template std::string Join(const std::vector<std::string>&, const std::string&);
extern template std::string Join(const std::vector<const char*>&, const std::string&);
extern template std::string Join(const std::vector<std::string_view>&, const std::string&);
