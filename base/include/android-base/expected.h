...
class _NODISCARD_ expected {
 public:
  ...
  template <class U = T _ENABLE_IF(
                ...
                !std::is_same_v<std::remove_cv_t<std::remove_reference<U>>, std::in_place_t> &&
                !std::is_same_v<expected<T, E>, std::remove_cv_t<std::remove_reference<U>>> &&
                !std::is_same_v<unexpected<E>, std::remove_cv_t<std::remove_reference<U>>> &&
...
class unexpected {
 public:
  ...
  template <class Err = E _ENABLE_IF(
                ...
                !std::is_same_v<std::remove_cv_t<std::remove_reference<E>>, std::in_place_t> &&
                !std::is_same_v<std::remove_cv_t<std::remove_reference<E>>, unexpected>)>
