...
#define WOULD_LOG(severity) WOULD_LOGS(::android::base::severity)
#define WOULD_LOGS(severity) \
...
#define LOG_STREAM(severity) LOGS_STREAM(::android::base::severity)
#define LOGS_STREAM(severity) LOGS_STREAM_TO(DEFAULT, severity)
...
#define LOG_STREAM_TO(dest, severity) LOGS_STREAM_TO(dest, ::android::base::severity)
#define LOGS_STREAM_TO(dest, severity)                                  \
...
#define LOG(severity) LOGS(::android::base::severity)
#define LOGS(severity) LOGS_TO(DEFAULT, severity)
...
#define LOG_TO(dest, severity) LOGS_TO(dest, ::android::base::severity)
#define LOGS_TO(dest, severity)           \
  WOULD_LOGS(severity) &&                 \
    ::android::base::ErrnoRestorer() &&   \
      LOGS_STREAM_TO(dest, severity)      \

// A variant of LOG that also logs the current errno value. To be used when
// library calls fail.
#define PLOG(severity) PLOGS(::android::base::severity)
#define PLOGS(severity) PLOGS_TO(DEFAULT, severity)

// Behaves like PLOG, but logs to the specified log ID.
#define PLOG_TO(dest, severity) PLOGS_TO(dest, ::android::base::severity)
#define PLOGS_TO(dest, severity)                       \
  WOULD_LOGS(severity) &&                              \
    ::android::base::ErrnoRestorer() &&                \
      ::android::base::LogMessage(__FILE__, __LINE__,  \
          ::android::base::dest,                       \
