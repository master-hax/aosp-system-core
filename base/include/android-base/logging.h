...
#define LOG_STREAM(severity) LOG_S_STREAM(::android::base::severity)
#define LOG_S_STREAM(severity) LOG_S_STREAM_TO(DEFAULT, severity)
...
#define LOG_STREAM_TO(dest, severity) LOG_S_STREAM_TO(dest, ::android::base::severity)
#define LOG_S_STREAM_TO(dest, severity)                                 \
...
#define LOG_S(severity) LOG_S_TO(DEFAULT, severity)
...
#define LOG_TO(dest, severity) LOG_S_TO(dest, ::android::base::severity)
#define LOG_S_TO(dest, severity)           \
  WOULD_LOG_SEVERITY(severity) &&          \
    ::android::base::ErrnoRestorer() &&    \
      LOG_S_STREAM_TO(dest, severity)      \

// A variant of LOG that also logs the current errno value. To be used when
// library calls fail.
#define PLOG(severity) PLOG_S(::android::base::severity)
#define PLOG_S(severity) PLOG_S_TO(DEFAULT, severity)

// Behaves like PLOG, but logs to the specified log ID.
#define PLOG_TO(dest, severity) PLOG_S_TO(dest, ::android::base::severity)
#define PLOG_S_TO(dest, severity)                       \
  WOULD_LOG_SEVERITY(severity) &&                       \
    ::android::base::ErrnoRestorer() &&                 \
      ::android::base::LogMessage(__FILE__, __LINE__,   \
          ::android::base::dest,                        \
