...
struct DefaultCloser {
  ...
  static void Tag(int fd, void* expected_tag, void* new_tag) {
    android_fdsan_exchange_close_tag(fd, expected_tag, new_tag);
  }
  static void Close(int fd, void* tag) { android_fdsan_close_with_tag(fd, tag); }
#else
  static void Tag(int, void*, void*) {}
  static void Close(int fd, void*) {
