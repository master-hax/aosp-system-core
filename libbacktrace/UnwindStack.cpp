...
bool UnwindStackCurrent::UnwindFromContext(size_t num_ignore_frames, ucontext_t* ucontext) {
  ...
  if (ucontext == nullptr) {
    ...
    regs.reset(unwindstack::Regs::CreateFromUcontext(unwindstack::Regs::CurrentType(), ucontext));
  }
...
bool UnwindStackPtrace::Unwind(size_t num_ignore_frames, ucontext_t* context) {
  ...
  if (context == nullptr) {
    ...
    regs.reset(unwindstack::Regs::CreateFromUcontext(unwindstack::Regs::CurrentType(), context));
  }
