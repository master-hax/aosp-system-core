...
using recvmmsg_timespec_t = const struct timespec*;
#else
using recvmmsg_timespec_t = struct timespec*;
#endif

int __real_recvmmsg(int sockfd, struct mmsghdr* msgvec, unsigned int vlen, unsigned int flags,
