...
General options:
  ...
  -c, --clear                 Clear (flush) the entire log and exit.
                              if -f is specified, clear the associated files instead.
...
Filtering:
  ...
  -t <count>                  Print the most recent <count> lines (implies -d).
  -t '<time>'                 Print the most recent lines since specified time (implies -d).
  -T <count>                  Print the most recent <count> lines (does not imply -d).
  -T '<time>'                 Print the most recent lines since specified time (not imply -d).
