...
static void show_help(const char *cmd)
{
    ...
    fprintf(stderr, "options include:\n"
                    ...
                    "  -D or --dividers              Print dividers between each log buffer\n"
                    "  -c or --clear   Clear (flush) the entire log and exit\n"
                    "  -d              Dump the log and then exit (don't block)\n"
                    "  -e <expr>       Only print lines where the log message matches <expr>\n"
                    "    or --regex <expr>           where <expr> is a regular expression\n"
                    "  -m <count>      Quit after printing <count> lines. This is meant to be\n"
                    "    or --max-count=<count>      paired with --regex, but will work on its own.\n"
                    ...
                    "  -g or --buffer-size           Get the size of the log's ring buffer and exit\n"
                    "  -G <size>       Set size of log ring buffer, may suffix with K or M.\n"
                    "    or --buffer-size=<size>\n"
                    "  -L or --last    Dump logs from prior to last reboot\n"
                    ...
                    "    or --prune='<list> ...'     printed above. Must be quoted.\n"
