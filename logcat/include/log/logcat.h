...
/* For managing an in-process logcat, rather than forking/execing
 *
 * The following C API allows a logcat instance to be created, run
 * to fruition, and then release all the associated resources.
 */
...
/* Collects and outputs the logcat data until fruition.
 *
