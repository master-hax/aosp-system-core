...
#endif
#ifdef logcat_executable
#define USING_LOGCAT_EXECUTABLE
#else
...
#ifdef logcat
#ifdef USING_LOGCAT_EXECUTABLE
#define logcat_regex_prefix "logcatd_test"
#else
#define logcat_regex_prefix "liblogcat_test"
#endif
#else
