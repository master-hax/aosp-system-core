...
// HAL's HalHealthLoop.
class ChargerHidl : public ::android::ChargerHalHealthLoopInterface,
  ...
  public:
    ...
    void ChargerInitConfig(healthd_config* config, void*) override {
        return HalHealthLoop::Init(config);
    }
    ...
    void Init(struct healthd_config* config) override {
        charger_->OnInit(config, nullptr /* cookie */);
    }
