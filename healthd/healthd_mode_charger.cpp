...
void Charger::UpdateScreenState(int64_t now) {
    ...
    if (healthd_draw_ == nullptr) {
        ...
        service()->getScreenOn([&](Result res, bool screen_on) {
...
Return<void> Charger::healthInfoChanged(const HealthInfo_2_0& health_info) {
...
int healthd_charger_main(int argc, char** argv) {
    ...
    sp<IHealth> passthrough =
            IHealth::castFrom(IHealth_2_0::getService("default", true /* getStub */));
    LOG_FATAL_IF(passthrough == nullptr,
                 "Cannot find passthrough implementation of health 2.1 HAL for instance default");
    sp<Charger> charger = new Charger(passthrough);
