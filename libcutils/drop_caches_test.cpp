...
TEST(drop_caches, set_perf_property) {
    ...
    ALOGI("(before) Minor faults before: %ld", usage_before_minor.ru_minflt);
    ALOGI("(before) Minor faults after: %ld", usage_after_minor.ru_minflt);
    ALOGI("(before) Minor faults diff: %ld",
          usage_after_minor.ru_minflt - usage_before_minor.ru_minflt);
    ALOGI("(before) Major faults before: %ld", usage_before_minor.ru_majflt);
    ALOGI("(before) Major faults after: %ld", usage_after_minor.ru_majflt);
