...
TEST(drop_caches, set_perf_property) {
    ...
    int with_cache_minor_faults = usage_after_minor.ru_minflt - usage_before_minor.ru_minflt;
    ...
    int without_cache_major_faults = usage_after_major.ru_minflt - usage_before_major.ru_minflt;
