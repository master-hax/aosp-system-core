...
static inline bool prefix_cmp(bool partial, const char* prefix, size_t len, const char* path, size_t plen) {
...
static bool fs_config_cmp(bool partial, const char* prefix, size_t len, const char* path, size_t plen) {
