...
static const struct fs_path_config android_files[] = {
    ...
    // TODO before submitting this CL: Is this the right way to give the binary
    // CAP_SYS_ADMIN capabilities?
    { 00550, AID_KEYSTORE,      AID_KEYSTORE,     CAP_MASK_LONG(CAP_SYS_ADMIN), "system/bin/keystore2_increment_crng_entropy_count" },
    // generic defaults
