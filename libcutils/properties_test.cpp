...
TEST_F(PropertiesTest, property_get_null_key) {
    // Null key -> fails, returns default.
    char buf[PROPERTY_VALUE_MAX] = "hello";
    EXPECT_EQ(7, property_get(/*key*/ NULL, buf, "default"));
