...
static const struct fs_path_config android_files[] = {
    ...
    { 00750, AID_ROOT,      AID_SHELL,     CAP_TO_MASK(CAP_SETUID) | CAP_TO_MASK(CAP_SETGID), "system/bin/run-as" },
    { 00700, AID_SYSTEM,    AID_SHELL,     CAP_TO_MASK(CAP_BLOCK_SUSPEND), "system/bin/inputflinger" },
