 ...
 *
 * Set default value of memfd_supported to MEMFD_SUPPORT_UNKNOWN once the issue
 * is resolved, so that the code can then self-detect if kernel support is
 * present.
 */

#define MEMFD_SUPPORT_UNKNOWN -1
#define MEMFD_NOT_SUPPORTED    0
#define MEMFD_SUPPORTED        1

static std::atomic<int> memfd_supported = MEMFD_NOT_SUPPORTED;
