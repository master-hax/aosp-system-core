...
/** Environment-specific implementation of atrace_begin. */
void atrace_begin_body(const char*);

/** Environment-specific implementation of atrace_end. */
void atrace_end_body();

/** Environment-specific implementation of atrace_async_begin. */
void atrace_async_begin_body(const char*, int32_t);

/** Environment-specific implementation of atrace_async_end. */
void atrace_async_end_body(const char*, int32_t);

/** Environment-specific implementation of atrace_async_for_track_begin. */
void atrace_async_for_track_begin_body(const char*, const char*, int32_t);

/** Environment-specific implementation of atrace_async_for_track_end. */
void atrace_async_for_track_end_body(const char*, int32_t);

/** Environment-specific implementation of atrace_instant. */
void atrace_instant_body(const char*);

/** Environment-specific implementation of atrace_instant_for_track. */
void atrace_instant_for_track_body(const char*, const char*);

/** Environment-specific implementation of atrace_int. */
void atrace_int_body(const char*, int32_t);

/** Environment-specific implementation of atrace_int64. */
