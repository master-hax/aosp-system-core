...
/*
 * This file describes the project ID values we use for filesystem quota tracking.
 * It is used on devices that don't have the sdcardfs kernel module, which requires
 * us to use filesystem project IDs for efficient quota calculation.
 */

#ifndef _ANDROID_PROJECTID_CONFIG_H_
#define _ANDROID_PROJECTID_CONFIG_H_
