...
ifneq ($(SCUDO_ALLOCATION_RING_BUFFER_SIZE),)
	EXPORT_GLOBAL_SCUDO_ALLOCATION_RING_BUFFER_SIZE := export SCUDO_ALLOCATION_RING_BUFFER_SIZE $(SCUDO_ALLOCATION_RING_BUFFER_SIZE)
endif
