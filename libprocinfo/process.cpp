...
bool GetProcessInfo(pid_t tid, ProcessInfo* process_info, bool report_error) {
  char path[PATH_MAX];
  ...
  return GetProcessInfoFromProcPidFd(dirfd.get(), process_info, report_error);
}
...
bool GetProcessInfoFromProcPidFd(int fd, ProcessInfo* process_info, bool report_error) {
