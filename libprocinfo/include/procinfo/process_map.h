...
inline bool ReadMapFile(const std::string& map_file,
                        const std::function<void(uint64_t, uint64_t, uint16_t, uint64_t, uint64_t,
                                                 const char*)>& callback) {
  std::string content;
...
inline bool ReadProcessMaps(pid_t pid,
                            const std::function<void(uint64_t, uint64_t, uint16_t, uint64_t,
                                                     uint64_t, const char*)>& callback) {
...
struct MapInfo {
  ...
  MapInfo(uint64_t start, uint64_t end, uint16_t flags, uint64_t pgoff, uint64_t inode,
          const char* name)
...
inline bool ReadProcessMaps(pid_t pid, std::vector<MapInfo>* maps) {
  return ReadProcessMaps(
      pid, [&](uint64_t start, uint64_t end, uint16_t flags, uint64_t pgoff, uint64_t inode,
