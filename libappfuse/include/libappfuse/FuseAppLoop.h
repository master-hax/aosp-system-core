...
class FuseAppLoop {
 public:
  ...
  bool Start(int fd, Callback* callback);

 private:
  void HandleLookUp(Callback* callback);
  void HandleGetAttr(Callback* callback);
  void HandleOpen(Callback* callback);
  void HandleFsync(Callback* callback);
  void HandleRelease(Callback* callback);
  void HandleRead(Callback* callback);
  void HandleWrite(Callback* callback);
