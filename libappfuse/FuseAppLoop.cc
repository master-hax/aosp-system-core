...
void HandleLookUp(FuseBuffer* buffer, FuseAppLoop::Callback* callback) {
...
void HandleGetAttr(FuseBuffer* buffer, FuseAppLoop::Callback* callback) {
...
void HandleOpen(FuseBuffer* buffer, FuseAppLoop::Callback* callback) {
...
void HandleFsync(FuseBuffer* buffer, FuseAppLoop::Callback* callback) {
  buffer->response.Reset(0, callback->OnFsync(buffer->request.header.nodeid),
                         buffer->request.header.unique);
}

void HandleRelease(FuseBuffer* buffer, FuseAppLoop::Callback* callback) {
  buffer->response.Reset(0, callback->OnRelease(buffer->request.header.nodeid),
                         buffer->request.header.unique);
}

void HandleRead(FuseBuffer* buffer, FuseAppLoop::Callback* callback) {
...
void HandleWrite(FuseBuffer* buffer, FuseAppLoop::Callback* callback) {
  const uint64_t unique = buffer->request.header.unique;
  const uint64_t nodeid = buffer->request.header.nodeid;
