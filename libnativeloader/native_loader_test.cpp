...
class NativeLoaderTest_Create : public NativeLoaderTest<bridged> {
 protected:
  ...
  void SetExpectations() {
    NativeLoaderTest<bridged>::SetExpectations();
  ...
  JNIEnv* env() { return NativeLoaderTest<bridged>::env.get(); }
};
...
// TODO(b/b/130388701#comment22) add a test for anonymous namespace
