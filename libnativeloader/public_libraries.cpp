...
std::string GetDefaultPublicLibraries() {
  ...
  std::vector<std::string> additional_libs = base::Split(additional_public_libraries(), ":");
  std::copy(additional_libs.begin(), additional_libs.end(), std::back_inserter(sonames));
...
std::string GetRuntimePublicLibraries() {
...
std::string GetVendorPublicLibraries() {
...
std::string GetExtendedPublicLibraries() {
  std::vector<std::string> sonames;
...
const std::string& default_public_libraries() {
  static std::string list = GetDefaultPublicLibraries();
  return list;
}

const std::string& runtime_public_libraries() {
  static std::string list = GetRuntimePublicLibraries();
  return list;
}

const std::string& vendor_public_libraries() {
  static std::string list = GetVendorPublicLibraries();
  return list;
}

const std::string& extended_public_libraries() {
  static std::string list = GetExtendedPublicLibraries();
  return list;
}

const std::string& llndk_libraries() {
  static std::string list = GetLlndkLibraries();
  return list;
}

const std::string& vndksp_libraries() {
  static std::string list = GetVndkspLibraries();
  return list;
}
