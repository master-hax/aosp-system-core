...
class LibraryNamespaces {
 public:
  ...
  void Initialize() {
    ...
    // For example, libicuuc.so are exposed to classloader namespace from runtime namespace.
    // Unfortunately, it does not have stable C symbosl, and default namespace should only use
