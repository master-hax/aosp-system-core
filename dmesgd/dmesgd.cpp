...
static void storeReport(const std::string& tag, const std::string& report) {
        ...
        do {
            ...
            if (newline == std::string::npos) {
                ...
                if (dmesg_parser.reportReady()) {
                    ...
                    if ((sent_reports < kMaxReports) && (title != last_report_title)) {
                        storeReport(tag, dmesg_parser.flushReport());
                        last_report_title = title;
                    }
                }
            }
        } while (true);
