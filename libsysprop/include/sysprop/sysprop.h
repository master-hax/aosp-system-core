...
#ifndef SYSTEM_CORE_LIBSYSPROP_INCLUDE_SYSPROP_SYSPROP_H_
#define SYSTEM_CORE_LIBSYSPROP_INCLUDE_SYSPROP_SYSPROP_H_
...
class SystemPropertyBase {
  ...
  private:
    SystemPropertyBase(const SystemPropertyBase<T>&) = delete;
    SystemPropertyBase<T>& operator=(const SystemPropertyBase<T>&) = delete;

    void Set(const T& value);

    virtual std::optional<T> ParseValue(const std::string& str) const = 0;
...
class DoubleProperty final : public SystemPropertyBase<double> {
    friend class android::os::PlatformProperties;
  ...
  private:
    ...
    std::optional<double> ParseValue(const std::string& str) const override final;
    std::string FormatValue(const double& value) const override final;
};

class FloatProperty final : public SystemPropertyBase<float> {
    friend class android::os::PlatformProperties;
  ...
  private:
    ...
    std::optional<float> ParseValue(const std::string& str) const override final;
    std::string FormatValue(const float& value) const override final;
};

class IntegerProperty final : public SystemPropertyBase<std::int32_t> {
    friend class android::os::PlatformProperties;
  ...
  private:
    ...
    std::optional<std::int32_t> ParseValue(const std::string& str) const override final;
    std::string FormatValue(const std::int32_t& value) const override final;
};

class LongProperty final : public SystemPropertyBase<std::int64_t> {
    friend class android::os::PlatformProperties;
  ...
  private:
    LongProperty(const std::string& name, PropertyNamespace prop_namespace, bool writeonce,
                 std::optional<std::int64_t> default_value, Accessor accessor,
                 bool is_platform_prop);
    std::optional<std::int64_t> ParseValue(const std::string& str) const override final;
    std::string FormatValue(const std::int64_t& value) const override final;
};

class StringProperty final : public SystemPropertyBase<std::string> {
    friend class android::os::PlatformProperties;
  ...
  private:
    StringProperty(const std::string& name, PropertyNamespace prop_namespace, bool writeonce,
                   std::optional<std::string> default_value, Accessor accessor,
                   bool is_platform_prop);
    std::optional<std::string> ParseValue(const std::string& str) const override final;
    std::string FormatValue(const std::string& value) const override final;
};

class BooleanProperty final : public SystemPropertyBase<bool> {
    friend class android::os::PlatformProperties;
  ...
  private:
    ...
    std::optional<bool> ParseValue(const std::string& str) const override final;
...
class EnumProperty final : public SystemPropertyBase<std::int32_t> {
    friend class android::os::PlatformProperties;
...
template <typename T>
class ListPropertyBase final : public SystemPropertyBase<std::vector<T>> {
    friend class android::os::PlatformProperties;

  public:
    ListPropertyBase(const std::string& name, PropertyNamespace prop_namespace, bool writeonce,
                     std::optional<std::vector<T>> default_value,
  ...
  private:
    ...
    std::optional<std::vector<T>> ParseValue(const std::string& str) const override final;
    std::string FormatValue(const std::vector<T>& value) const override final;
};

class EnumListProperty final : public SystemPropertyBase<std::vector<std::int32_t>> {
    friend class android::os::PlatformProperties;

  public:
    EnumListProperty(const std::string& name, PropertyNamespace prop_namespace, bool writeonce,
                     std::optional<std::vector<std::int32_t>> default_value, Accessor accessor,
                     std::unordered_map<std::string, std::int32_t> enum_values);
    ~EnumListProperty();
  ...
  private:
    ...
    std::optional<std::vector<std::int32_t>> ParseValue(const std::string& str) const override final;
    std::string FormatValue(const std::vector<std::int32_t>& value) const override final;

    std::unique_ptr<EnumPropertyImpl> const impl_;
};

// List of defined classes in libsysprop
...
extern template class SystemPropertyBase<std::vector<bool>>;
extern template class SystemPropertyBase<std::vector<std::int32_t>>;
extern template class SystemPropertyBase<std::vector<std::int64_t>>;
extern template class SystemPropertyBase<std::vector<double>>;
extern template class SystemPropertyBase<std::vector<float>>;
extern template class SystemPropertyBase<std::vector<std::string>>;

extern template class ListPropertyBase<bool>;
extern template class ListPropertyBase<std::int32_t>;
extern template class ListPropertyBase<std::int64_t>;
extern template class ListPropertyBase<double>;
extern template class ListPropertyBase<float>;
extern template class ListPropertyBase<std::string>;

using BooleanListProperty = ListPropertyBase<bool>;
using IntegerListProperty = ListPropertyBase<std::int32_t>;
using LongListProperty = ListPropertyBase<std::int64_t>;
using FloatListProperty = ListPropertyBase<float>;
using DoubleListProperty = ListPropertyBase<double>;
using StringListProperty = ListPropertyBase<std::string>;

}  // namespace android::sysprop

#endif  // #ifndef SYSTEM_CORE_LIBSYSPROP_INCLUDE_SYSPROP_SYSPROP_H_
