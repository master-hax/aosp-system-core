...
static void handleStagedUninstall(std::string& dataStagedDirName, std::string& dataCurrentDirName,
                                  PathStatus dataCurrentDirStatus) {
...
static void handleStagedInstall(std::string& dataStagedDirName, std::string& dataCurrentDirName,
                                PathStatus dataCurrentDirStatus) {
 ...
 */
static void processStagedOperation(std::string& dataStagedDirName, std::string& dataCurrentDirName) {
    ...
    int uninstallTombStoneFileStatus = checkPath(dataStagedDirName);
