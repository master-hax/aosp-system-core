...
class Arm : public MachineType {
 public:
  ...
  uint16_t IpReg() override { return 14; }
  uint16_t SpReg() override { return 13; }
};
...
class Arm64 : public MachineType {
 public:
  ...
  uint16_t IpReg() override { return 32; }
  uint16_t SpReg() override { return 31; }
};
...
class X86 : public MachineType {
 public:
  ...
  uint16_t IpReg() override { return 8; }
  uint16_t SpReg() override { return 7; }
};
...
class X86_64 : public MachineType {
 public:
  ...
  uint16_t IpReg() override { return 17; }
  uint16_t SpReg() override { return 7; }
};
