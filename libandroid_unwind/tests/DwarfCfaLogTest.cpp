...
class DwarfCfaLogTest : public ::testing::Test {
 protected:
  virtual void SetUp() {
    ...
    dmem_.reset(new DwarfMemory<TypeParam>(&memory_));
    ...
    cfa_.reset(new DwarfCfa<TypeParam>(dmem_.get(), &cie_, &fde_));
  }

  MemoryFake memory_;
  std::unique_ptr<DwarfMemory<TypeParam>> dmem_;
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_illegal) {
  for (uint8_t i = 0x17; i < 0x3f; i++) {
    ...
    ResetLogs();
    ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x2000, 0x2001));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_offset) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x2000, 0x2002));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x2100, 0x2103));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_offset_extended) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x500, 0x503));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x1500, 0x1505));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_restore) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x3000, 0x3003));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_restore_extended) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x4000, 0x4002));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x5000, 0x5007));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_set_loc) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x50, 0x51 + sizeof(TypeParam)));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_advance_loc1) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x200, 0x202));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_advance_loc2) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x600, 0x603));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_advance_loc4) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x500, 0x505));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_undefined) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0xa00, 0xa02));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x1a00, 0x1a03));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_same) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x100, 0x102));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_register) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x300, 0x303));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x4300, 0x4305));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_state) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x300, 0x301));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x4300, 0x4301));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_state_cfa_offset_restore) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x3000, 0x3004));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x100, 0x103));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x200, 0x205));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_register) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x200, 0x203));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_expression) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x100, 0x106));
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x200, 0x284));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_expression) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x100, 0x105));
  ...
  this->memory_.SetMemory(0x200, ops);
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x200, 0x287));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_offset) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x400, 0x405));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_offset_sf) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0xa00, 0xa05));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_expression) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0xa00, 0xaad));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_gnu_args_size) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x5000, 0x5004));
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_register_override) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x300, 0x306));
