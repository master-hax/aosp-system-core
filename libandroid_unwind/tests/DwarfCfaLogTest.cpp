...
TYPED_TEST_P(DwarfCfaLogTest, cfa_illegal) {
  for (uint8_t i = 0x17; i < 0x3f; i++) {
    ...
    std::string expected = android::base::StringPrintf("4 unwind Raw Data: 0x%02x\n", i);
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_offset_extended) {
  ...
  expected = "4 unwind Raw Data: 0x05 0x81 0x01 0x82 0x12\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_offset_extended_sf) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x1500, 0x1505));
  expected = "4 unwind Raw Data: 0x11 0x86 0x01 0xff 0x7f\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_restore) {
  ...
  expected = "4 unwind Raw Data: 0x82 0x04\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_restore_extended) {
  ...
  std::string expected = "4 unwind Raw Data: 0x06 0x08\n"
  ...
  expected = "4 unwind Raw Data: 0x05 0x82 0x02 0x04\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_undefined) {
  ...
  expected = "4 unwind Raw Data: 0x07 0x81 0x01\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_same) {
  ...
  ASSERT_TRUE(this->cfa_->Log(0, this->fde_.start_pc, 0x2100, 0x2103));
  expected = "4 unwind Raw Data: 0x08 0xff 0x01\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_register) {
  ...
  expected = "4 unwind Raw Data: 0x09 0xff 0x01 0xff 0x03\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_state) {
  ...
  expected = "4 unwind Raw Data: 0x0b\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa) {
  ...
  expected = "4 unwind Raw Data: 0x0c 0xff 0x02 0xf4 0x04\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_sf) {
  ...
  expected = "4 unwind Raw Data: 0x12 0xa3 0x01 0xfa 0x7f\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_register) {
  ...
  expected = "4 unwind Raw Data: 0x0d 0xf9 0x20\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_offset) {
  ...
  expected = "4 unwind Raw Data: 0x0e 0xd4 0x0a\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_def_cfa_offset_sf) {
  ...
  expected = "4 unwind Raw Data: 0x13 0xf6 0x7f\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_offset) {
  ...
  expected = "4 unwind Raw Data: 0x14 0xa2 0x02 0xb4 0x05\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_val_offset_sf) {
  ...
  expected = "4 unwind Raw Data: 0x15 0xff 0x01 0xc0 0x7f\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_gnu_args_size) {
  ...
  expected = "4 unwind Raw Data: 0x2e 0xa4 0x80 0x04\n"
...
TYPED_TEST_P(DwarfCfaLogTest, cfa_gnu_negative_offset_extended) {
  ...
  expected = "4 unwind Raw Data: 0x2f 0x81 0x02 0xff 0x01\n"
...
INSTANTIATE_TYPED_TEST_CASE_P(My, DwarfCfaLogTest, DwarfCfaLogTestTypes);
