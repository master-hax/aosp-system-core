...
TYPED_TEST_P(DwarfCfaTest, cfa_illegal) {
  for (uint8_t i = 0x17; i < 0x3f; i++) {
    ...
    ASSERT_FALSE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x2000, 0x2001, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_nop) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x2000, 0x2001, &loc_regs));
  ASSERT_EQ(0x2001U, this->dmem_->cur_offset());
...
TYPED_TEST_P(DwarfCfaTest, cfa_offset) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x2000, 0x2002, &loc_regs));
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x2100, 0x2103, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_offset_extended) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x500, 0x503, &loc_regs));
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x1500, 0x1505, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_restore) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x3000, 0x3003, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_restore_extended) {
  ...
  ASSERT_FALSE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x4000, 0x4002, &loc_regs));
  ASSERT_EQ(DWARF_ERROR_ILLEGAL_STATE, this->cfa_->last_error());
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x5000, 0x5007, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_set_loc) {
  ...
  ResetLogs();
  dwarf_loc_regs_t loc_regs;
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x50, 0x51 + sizeof(TypeParam), &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_advance_loc1) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x200, 0x202, &loc_regs));
  ASSERT_EQ(0x202U, this->dmem_->cur_offset());
  ASSERT_EQ(this->fde_.start_pc + 0x10, this->cfa_->cur_pc());
  ASSERT_EQ(0U, loc_regs.size());
...
TYPED_TEST_P(DwarfCfaTest, cfa_advance_loc2) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x600, 0x603, &loc_regs));
  ASSERT_EQ(0x603U, this->dmem_->cur_offset());
  ASSERT_EQ(this->fde_.start_pc + 0xc10U, this->cfa_->cur_pc());
  ASSERT_EQ(0U, loc_regs.size());
...
TYPED_TEST_P(DwarfCfaTest, cfa_advance_loc4) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x500, 0x505, &loc_regs));
  ASSERT_EQ(0x505U, this->dmem_->cur_offset());
  ASSERT_EQ(this->fde_.start_pc + 0x4080c10, this->cfa_->cur_pc());
  ASSERT_EQ(0U, loc_regs.size());
...
TYPED_TEST_P(DwarfCfaTest, cfa_undefined) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0xa00, 0xa02, &loc_regs));
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x1a00, 0x1a03, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_same) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x100, 0x102, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_register) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x300, 0x303, &loc_regs));
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x4300, 0x4305, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_state) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x300, 0x301, &loc_regs));
  ...
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x4300, 0x4301, &loc_regs));
  ...
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x2000, 0x2005, &loc_regs));
  ...
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x2000, 0x2006, &loc_regs));
  ASSERT_EQ(0x2006U, this->dmem_->cur_offset());
  ASSERT_EQ(1U, loc_regs.size());
  ASSERT_NE(loc_regs.end(), loc_regs.find(5));

  ResetLogs();
  this->memory_.SetMemory(0x6000,
                    std::vector<uint8_t>{0x0a, 0x85, 0x02, 0x0a, 0x86, 0x04, 0x0a,
                                         0x87, 0x01, 0x0a, 0x89, 0x05, 0x0b, 0x0b,
                                         0x0b, 0x0b, 0x0b});

  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x6000, 0x600c, &loc_regs));
  ...
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x6000, 0x600d, &loc_regs));
  ...
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x6000, 0x600e, &loc_regs));
  ...
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x6000, 0x600f, &loc_regs));
  ASSERT_EQ(0x600fU, this->dmem_->cur_offset());
  ASSERT_EQ(1U, loc_regs.size());
  ASSERT_NE(loc_regs.end(), loc_regs.find(5));

  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x6000, 0x6010, &loc_regs));
  ASSERT_EQ(0x6010U, this->dmem_->cur_offset());
  ASSERT_EQ(0U, loc_regs.size());

  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x6000, 0x6011, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_state_cfa_offset_restore) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x3000, 0x3004, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_def_cfa) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x100, 0x103, &loc_regs));
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x200, 0x205, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_def_cfa_register) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x200, 0x203, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_def_cfa_offset) {
  ...
  ASSERT_FALSE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x100, 0x102, &loc_regs));
  ASSERT_EQ(0U, loc_regs.size());
  ASSERT_EQ(DWARF_ERROR_ILLEGAL_STATE, this->cfa_->last_error());
...
TYPED_TEST_P(DwarfCfaTest, cfa_def_cfa_expression) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x100, 0x106, &loc_regs));
  ...
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x200, 0x284, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_expression) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x100, 0x105, &loc_regs));
  ...
  this->memory_.SetMemory(0x200, ops);
  loc_regs.clear();
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x200, 0x287, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_val_offset) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x400, 0x405, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_val_offset_sf) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0xa00, 0xa05, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_val_expression) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0xa00, 0xaad, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_gnu_args_size) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x5000, 0x5004, &loc_regs));
...
TYPED_TEST_P(DwarfCfaTest, cfa_register_override) {
  ...
  ASSERT_TRUE(this->cfa_->GetLocationInfo(this->fde_.start_pc, 0x300, 0x306, &loc_regs));
...
REGISTER_TYPED_TEST_CASE_P(DwarfCfaTest,
                           cfa_illegal,
                           cfa_nop,
                           cfa_offset,
                           cfa_offset_extended,
...
INSTANTIATE_TYPED_TEST_CASE_P(My, DwarfCfaTest, DwarfCfaTestTypes);
