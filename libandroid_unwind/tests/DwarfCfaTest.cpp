...
void DwarfCfaTest::cfa_illegal_test(DwarfMemory<AddressType>* dmem, uint64_t offset,
  ...
  ASSERT_FALSE(cfa.Eval(fde_.start_pc, offset + index * 4, offset + 1 + index * 4));
...
void DwarfCfaTest::cfa_nop_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x2000, 0x2001));
  ASSERT_EQ(0x2001U, dmem->cur_offset());
  ASSERT_EQ(0U, cfa.regs().size());
...
TEST_F(DwarfCfaTest, cfa_offset) {
  ...
  ASSERT_TRUE(cfa32.Eval(fde_.start_pc, 0x2000, 0x2002));
  ASSERT_EQ(0x2002U, dmem32_->cur_offset());
  ASSERT_EQ(1U, cfa32.regs().size());
  ASSERT_NE(cfa32.regs().end(), cfa32.regs().find(3));
  ...
  ASSERT_TRUE(cfa64.Eval(fde_.start_pc, 0x2100, 0x2103));
  ASSERT_EQ(0x2103U, dmem64_->cur_offset());
  ASSERT_EQ(1U, cfa64.regs().size());
  ASSERT_NE(cfa64.regs().end(), cfa64.regs().find(3));
...
void DwarfCfaTest::cfa_offset_extended_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x500, 0x503));
  ASSERT_EQ(0x503U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(3));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x1500, 0x1505));
  ASSERT_EQ(0x1505U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(129));
...
void DwarfCfaTest::cfa_offset_extended_sf_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_EQ(0x503U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(5));
  ASSERT_EQ(DWARF_LOCATION_OFFSET, cfa.regs().find(5)->second.type);
  ASSERT_EQ(0x80U, cfa.regs().find(5)->second.value);
  ...
  ASSERT_EQ(0x1505U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(134));
  ASSERT_EQ(DWARF_LOCATION_OFFSET, cfa.regs().find(134)->second.type);
  ASSERT_EQ(static_cast<uint64_t>(-8), cfa.regs().find(134)->second.value);
...
void DwarfCfaTest::cfa_restore_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_FALSE(cfa.Eval(fde_.start_pc, 0x2000, 0x2001));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x3000, 0x3003));
  ASSERT_EQ(0x3003U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(2));
  ASSERT_EQ(DWARF_LOCATION_SAME, cfa.regs().find(2)->second.type);
...
void DwarfCfaTest::cfa_restore_extended_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_FALSE(cfa.Eval(fde_.start_pc, 0x4000, 0x4002));
  ...
  dwarf_regs_t regs;
  regs[258] = { .type = DWARF_LOCATION_SAME };
  cfa.set_cie_regs(&regs);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x5000, 0x5007));
  ASSERT_EQ(0x5007U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(258));
  ASSERT_EQ(DWARF_LOCATION_SAME, cfa.regs().find(258)->second.type);
...
void DwarfCfaTest::cfa_set_loc_test(DwarfMemory<AddressType>* dmem) {
  ...
  ResetLogs();
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x50, 0x51 + sizeof(AddressType)));
...
void DwarfCfaTest::cfa_advance_loc1_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x200, 0x202));
...
void DwarfCfaTest::cfa_advance_loc2_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x600, 0x603));
...
void DwarfCfaTest::cfa_advance_loc4_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x500, 0x505));
...
void DwarfCfaTest::cfa_undefined_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0xa00, 0xa02));
  ...
  dwarf_regs_t regs;
  regs[129] = { .type = DWARF_LOCATION_SAME };
  cfa.set_cie_regs(&regs);

  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x1a00, 0x1a03));
...
void DwarfCfaTest::cfa_same_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x100, 0x102));
  ASSERT_EQ(0x102U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(127));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x2100, 0x2103));
  ASSERT_EQ(0x2103U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(255));
...
void DwarfCfaTest::cfa_register_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x300, 0x303));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x4300, 0x4305));
...
void DwarfCfaTest::cfa_state_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x300, 0x301));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x4300, 0x4301));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x2000, 0x2005));
  ASSERT_EQ(0x2005U, dmem->cur_offset());
  ASSERT_EQ(2U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(5));
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(6));

  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x2000, 0x2006));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x6000, 0x600c));
  ASSERT_EQ(0x600cU, dmem->cur_offset());
  ASSERT_EQ(4U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(5));
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(6));
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(7));
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(9));

  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x6000, 0x600d));
  ASSERT_EQ(0x600dU, dmem->cur_offset());
  ASSERT_EQ(3U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(5));
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(6));
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(7));

  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x6000, 0x600e));
  ASSERT_EQ(0x600eU, dmem->cur_offset());
  ASSERT_EQ(2U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(5));
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(6));

  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x6000, 0x600f));
  ASSERT_EQ(0x600fU, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(5));

  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x6000, 0x6010));
  ASSERT_EQ(0x6010U, dmem->cur_offset());
  ASSERT_EQ(0U, cfa.regs().size());

  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x6000, 0x6011));
...
void DwarfCfaTest::cfa_def_cfa_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x200, 0x205));
  ASSERT_EQ(0x205U, dmem->cur_offset());
  ASSERT_EQ(0U, cfa.regs().size());
  ASSERT_EQ(DWARF_LOCATION_REGISTER, cfa.cfa_location().type);
  ASSERT_EQ(0x17fU, cfa.cfa_location().value);
...
void DwarfCfaTest::cfa_def_cfa_sf_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_EQ(0U, cfa.regs().size());
  ASSERT_EQ(DWARF_LOCATION_REGISTER, cfa.cfa_location().type);
  ASSERT_EQ(0x30U, cfa.cfa_location().value);
  ...
  ASSERT_EQ(0U, cfa.regs().size());
  ASSERT_EQ(DWARF_LOCATION_REGISTER, cfa.cfa_location().type);
  ASSERT_EQ(0xa3U, cfa.cfa_location().value);
...
void DwarfCfaTest::cfa_def_cfa_register_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_EQ(0U, cfa.regs().size());
  ASSERT_EQ(DWARF_LOCATION_REGISTER, cfa.cfa_location().type);
  ASSERT_EQ(0x72U, cfa.cfa_location().value);
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x200, 0x203));
  ASSERT_EQ(0x203U, dmem->cur_offset());
  ASSERT_EQ(0U, cfa.regs().size());
  ASSERT_EQ(DWARF_LOCATION_REGISTER, cfa.cfa_location().type);
  ASSERT_EQ(0x1079U, cfa.cfa_location().value);
  ASSERT_EQ(0U, cfa.cfa_offset());
...
void DwarfCfaTest::cfa_def_cfa_offset_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_FALSE(cfa.Eval(fde_.start_pc, 0x100, 0x102));
  ASSERT_EQ(DWARF_ERROR_ILLEGAL_STATE, cfa.last_error());
  ...
  ResetLogs();
  cfa.set_cfa_location(DwarfLocation{.type = DWARF_LOCATION_REGISTER, .value = 3});
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x100, 0x102));
  ASSERT_EQ(0x102U, dmem->cur_offset());
  ASSERT_EQ(0U, cfa.regs().size());
  ASSERT_EQ(DWARF_LOCATION_REGISTER, cfa.cfa_location().type);
  ASSERT_EQ(3U, cfa.cfa_location().value);
...
void DwarfCfaTest::cfa_def_cfa_expression_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x100, 0x106));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x200, 0x284));
...
void DwarfCfaTest::cfa_expression_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x100, 0x105));
  ASSERT_EQ(0x105U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(4));
  ASSERT_EQ(DWARF_LOCATION_EXPRESSION, cfa.regs().find(4)->second.type);
  // TODO: Add some verification about the expresion data.
  ...
  memory_.SetMemory(0x200, ops);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x200, 0x287));
  ASSERT_EQ(0x287U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(255));
  ASSERT_EQ(DWARF_LOCATION_EXPRESSION, cfa.regs().find(255)->second.type);
...
void DwarfCfaTest::cfa_val_offset_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_EQ(0x103U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(69));
  ASSERT_EQ(DWARF_LOCATION_VAL_OFFSET, cfa.regs().find(69)->second.type);
  ASSERT_EQ(0x2a0U, cfa.regs().find(69)->second.value);
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x400, 0x405));
  ASSERT_EQ(0x405U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(290));
  ASSERT_EQ(DWARF_LOCATION_VAL_OFFSET, cfa.regs().find(290)->second.type);
  ASSERT_EQ(0x15a0U, cfa.regs().find(290)->second.value);
...
void DwarfCfaTest::cfa_val_offset_sf_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_EQ(0x103U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(86));
  ASSERT_EQ(DWARF_LOCATION_VAL_OFFSET, cfa.regs().find(86)->second.type);
  ASSERT_EQ(0x90U, cfa.regs().find(86)->second.value);
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0xa00, 0xa05));
  ASSERT_EQ(0xa05U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(255));
  ASSERT_EQ(DWARF_LOCATION_VAL_OFFSET, cfa.regs().find(255)->second.type);
  ASSERT_EQ(static_cast<uint64_t>(-512), cfa.regs().find(255)->second.value);
...
void DwarfCfaTest::cfa_val_expression_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(5));
  ASSERT_EQ(DWARF_LOCATION_VAL_EXPRESSION, cfa.regs().find(5)->second.type);
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0xa00, 0xaad));
  ASSERT_EQ(0xaadU, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(2051));
  ASSERT_EQ(DWARF_LOCATION_VAL_EXPRESSION, cfa.regs().find(2051)->second.type);
...
void DwarfCfaTest::cfa_gnu_args_size_test(DwarfMemory<AddressType>* dmem) {
  ...
  DwarfCfa<AddressType> cfa(dmem, &cie_, &fde_);
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x2000, 0x2002));
  ...
  ASSERT_TRUE(cfa.Eval(fde_.start_pc, 0x5000, 0x5004));
...
void DwarfCfaTest::cfa_gnu_negative_offset_extended_test(DwarfMemory<AddressType>* dmem) {
  ...
  ASSERT_EQ(0x503U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(8));
  ASSERT_EQ(DWARF_LOCATION_OFFSET, cfa.regs().find(8)->second.type);
  ASSERT_EQ(static_cast<uint64_t>(-16), cfa.regs().find(8)->second.value);
  ...
  ASSERT_EQ(0x1505U, dmem->cur_offset());
  ASSERT_EQ(1U, cfa.regs().size());
  ASSERT_NE(cfa.regs().end(), cfa.regs().find(257));
  ASSERT_EQ(DWARF_LOCATION_OFFSET, cfa.regs().find(257)->second.type);
  ASSERT_EQ(static_cast<uint64_t>(-255), cfa.regs().find(257)->second.value);
