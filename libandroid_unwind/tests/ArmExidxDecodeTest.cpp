...
class ArmExidxDecodeTest : public ::testing::TestWithParam<bool> {
 protected:
  void Init(Memory* process_memory = nullptr) {
    ...
    // Zero out the register memory.
    memset(reg_memory_, 0, sizeof(reg_memory_));

    exidx_ = new ArmExidx(new Regs32(0, 1, 1, reg_memory_), &elf_memory_, process_memory);
    if (log_) {
      exidx_->set_log(true);
...
TEST_P(ArmExidxDecodeTest, pop_up_to_12) {
  ...
  ASSERT_EQ(0x10004U, exidx_->cfa());
  ASSERT_EQ(0x10U, exidx_->regs()->value(4));
  ...
  ASSERT_EQ(0x20U, exidx_->regs()->value(4));
  ASSERT_EQ(0x21U, exidx_->regs()->value(5));
  ASSERT_EQ(0x22U, exidx_->regs()->value(6));
  ASSERT_EQ(0x23U, exidx_->regs()->value(7));
  ASSERT_EQ(0x24U, exidx_->regs()->value(8));
  ASSERT_EQ(0x25U, exidx_->regs()->value(9));
  ASSERT_EQ(0x26U, exidx_->regs()->value(10));
  ASSERT_EQ(0x27U, exidx_->regs()->value(11));
  ASSERT_EQ(0x28U, exidx_->regs()->value(12));
  ASSERT_EQ(0x29U, exidx_->regs()->value(13));
  ASSERT_EQ(0x2aU, exidx_->regs()->value(14));
  ASSERT_EQ(0x2bU, exidx_->regs()->value(15));
  ...
  ASSERT_EQ(0x11U, exidx_->regs()->value(7));
  ASSERT_EQ(0x22U, exidx_->regs()->value(9));
  ASSERT_EQ(0x33U, exidx_->regs()->value(12));
}
...
TEST_P(ArmExidxDecodeTest, pop_registers) {
  ...
  ASSERT_EQ(0x10004U, exidx_->cfa());
  ASSERT_EQ(0x14U, exidx_->regs()->value(4));
  ...
  ASSERT_EQ(0x20U, exidx_->regs()->value(4));
  ASSERT_EQ(0x30U, exidx_->regs()->value(5));
  ASSERT_EQ(0x40U, exidx_->regs()->value(6));
  ASSERT_EQ(0x50U, exidx_->regs()->value(7));
  ...
  ASSERT_EQ(0x10034U, exidx_->cfa());
  ASSERT_EQ(0x41U, exidx_->regs()->value(4));
  ASSERT_EQ(0x51U, exidx_->regs()->value(5));
  ASSERT_EQ(0x61U, exidx_->regs()->value(6));
  ASSERT_EQ(0x71U, exidx_->regs()->value(7));
  ASSERT_EQ(0x81U, exidx_->regs()->value(8));
  ASSERT_EQ(0x91U, exidx_->regs()->value(9));
  ASSERT_EQ(0xa1U, exidx_->regs()->value(10));
  ASSERT_EQ(0xb1U, exidx_->regs()->value(11));
}
...
TEST_P(ArmExidxDecodeTest, pop_registers_with_r14) {
  ...
  ASSERT_EQ(0x12U, exidx_->regs()->value(4));
  ASSERT_EQ(0x22U, exidx_->regs()->value(14));
  ...
  ASSERT_EQ(0x1U, exidx_->regs()->value(4));
  ASSERT_EQ(0x2U, exidx_->regs()->value(5));
  ASSERT_EQ(0x3U, exidx_->regs()->value(6));
  ASSERT_EQ(0x4U, exidx_->regs()->value(7));
  ASSERT_EQ(0x5U, exidx_->regs()->value(14));
  ...
  ASSERT_EQ(0x10040U, exidx_->cfa());
  ASSERT_EQ(0x1aU, exidx_->regs()->value(4));
  ASSERT_EQ(0x2aU, exidx_->regs()->value(5));
  ASSERT_EQ(0x3aU, exidx_->regs()->value(6));
  ASSERT_EQ(0x4aU, exidx_->regs()->value(7));
  ASSERT_EQ(0x5aU, exidx_->regs()->value(8));
  ASSERT_EQ(0x6aU, exidx_->regs()->value(9));
  ASSERT_EQ(0x7aU, exidx_->regs()->value(10));
  ASSERT_EQ(0x8aU, exidx_->regs()->value(11));
  ASSERT_EQ(0x9aU, exidx_->regs()->value(14));
}
...
TEST_P(ArmExidxDecodeTest, pop_registers_under_mask) {
  ...
  ASSERT_EQ(0x10004U, exidx_->cfa());
  ASSERT_EQ(0x45U, exidx_->regs()->value(0));
  ...
  ASSERT_EQ(0x1000cU, exidx_->cfa());
  ASSERT_EQ(0x23U, exidx_->regs()->value(1));
  ASSERT_EQ(0x24U, exidx_->regs()->value(3));
  ...
  ASSERT_EQ(0x1001cU, exidx_->cfa());
  ASSERT_EQ(0x65U, exidx_->regs()->value(0));
  ASSERT_EQ(0x54U, exidx_->regs()->value(1));
  ASSERT_EQ(0x43U, exidx_->regs()->value(2));
  ASSERT_EQ(0x32U, exidx_->regs()->value(3));
}
...
INSTANTIATE_TEST_CASE_P(Single, ArmExidxDecodeTest, ::testing::Bool());
