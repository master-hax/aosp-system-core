...
class ArmUnwindDecodeTest : public ::testing::Test {
 protected:
  void Init(StateArm arm, Memory* memory = nullptr) {
    delete exidx_;
    if (memory != nullptr) {
      exidx_ = new ArmUnwind(arm, memory);
    } else {
      exidx_ = new ArmUnwind(arm, &memory_);
    }
  }
  ...
  ArmUnwind* exidx_ = nullptr;
  std::deque<uint8_t>* data_;

  MemoryFake memory_;
};

TEST_F(ArmUnwindDecodeTest, vsp_incr) {
...
TEST_F(ArmUnwindDecodeTest, vsp_decr) {
  // 00xxxxxx: vsp = vsp - (xxxxxx << 2) + 4
...
TEST_F(ArmUnwindDecodeTest, refuse_unwind) {
...
TEST_F(ArmUnwindDecodeTest, pop_up_to_12) {
...
TEST_F(ArmUnwindDecodeTest, set_vsp_from_register) {
...
TEST_F(ArmUnwindDecodeTest, reserved_prefix) {
...
TEST_F(ArmUnwindDecodeTest, pop_registers) {
...
TEST_F(ArmUnwindDecodeTest, pop_registers_with_r14) {
...
TEST_F(ArmUnwindDecodeTest, finish) {
  // 10110000: Finish
...
TEST_F(ArmUnwindDecodeTest, spare) {
...
TEST_F(ArmUnwindDecodeTest, pop_registers_under_mask) {
...
TEST_F(ArmUnwindDecodeTest, vsp_large_incr) {
...
TEST_F(ArmUnwindDecodeTest, pop_vfp_fstmfdx) {
...
TEST_F(ArmUnwindDecodeTest, pop_vfp8_fstmfdx) {
...
TEST_F(ArmUnwindDecodeTest, pop_mmx_wr10) {
...
TEST_F(ArmUnwindDecodeTest, pop_mmx_wr) {
...
TEST_F(ArmUnwindDecodeTest, pop_mmx_wcgr) {
...
TEST_F(ArmUnwindDecodeTest, pop_vfp16_vpush) {
...
TEST_F(ArmUnwindDecodeTest, pop_vfp_vpush) {
...
TEST_F(ArmUnwindDecodeTest, pop_vfp8_vpush) {
...
TEST_F(ArmUnwindDecodeTest, expect_truncated) {
