...
void ElfInterfaceTest::SinglePtLoad() {
  std::unique_ptr<ElfInterfaceBase> elf(new ElfInterfaceType(&memory_));
...
TEST_F(ElfInterfaceTest, elf32_arm) {
  ...
  ASSERT_TRUE(elf_arm.ProcessProgramHeaders());
...
TEST_F(ElfInterfaceTest, elf32_dynamic_headers) {
  DynamicHeaders<Elf32_Ehdr, Elf32_Phdr, Elf32_Dyn, ElfInterface32>();
}

TEST_F(ElfInterfaceTest, elf64_dynamic_headers) {
  DynamicHeaders<Elf64_Ehdr, Elf64_Phdr, Elf64_Dyn, ElfInterface64>();
}
...
TEST_F(ElfInterfaceTest, elf32_dynamic_headers_after_dt_null) {
  DynamicHeaderAfterDtNull<Elf32_Ehdr, Elf32_Phdr, Elf32_Dyn, ElfInterface32>();
}

TEST_F(ElfInterfaceTest, elf64_dynamic_headers_after_dt_null) {
  DynamicHeaderAfterDtNull<Elf64_Ehdr, Elf64_Phdr, Elf64_Dyn, ElfInterface64>();
}
...
TEST_F(ElfInterfaceTest, elf32_dynamic_headers_size) {
  DynamicHeaderSize<Elf32_Ehdr, Elf32_Phdr, Elf32_Dyn, ElfInterface32>();
}

TEST_F(ElfInterfaceTest, elf64_dynamic_headers_size) {
  DynamicHeaderSize<Elf64_Ehdr, Elf64_Phdr, Elf64_Dyn, ElfInterface64>();
}
