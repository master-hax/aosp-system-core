...
static bool op_deref(Dwarf*) {
  return true;
}

static bool op_push(Dwarf* dwarf) {
  dwarf->InternalStackPushOperands();
  return true;
}

static bool op_dup(Dwarf* dwarf) {
  umaxptr_t value;
...
static bool op_drop(Dwarf* dwarf) {
  dwarf->InternalStackPop();
  return true;
}

static bool op_over(Dwarf* dwarf) {
  umaxptr_t value;
...
static bool op_pick(Dwarf* dwarf) {
  umaxptr_t index = dwarf->InternalOperandAt(0);
  umaxptr_t value;
...
static bool op_swap(Dwarf* dwarf) {
  return dwarf->InternalStackSwap();
}

static bool op_rot(Dwarf*) {
  return true;
}

static bool op_xderef(Dwarf*) {
  return true;
}

static bool op_abs(Dwarf*) {
  return true;
}

static bool op_and(Dwarf*) {
  return true;
}

static bool op_div(Dwarf*) {
  return true;
}

static bool op_minus(Dwarf*) {
  return true;
}

static bool op_mod(Dwarf*) {
  return true;
}

static bool op_mul(Dwarf*) {
  return true;
}

static bool op_neg(Dwarf*) {
  return true;
}

static bool op_not(Dwarf*) {
  return true;
}

static bool op_or(Dwarf*) {
  return true;
}

static bool op_plus(Dwarf*) {
  return true;
}

static bool op_plus_uconst(Dwarf*) {
  return true;
}

static bool op_shl(Dwarf*) {
  return true;
}

static bool op_shr(Dwarf*) {
  return true;
}

static bool op_shra(Dwarf*) {
  return true;
}

static bool op_xor(Dwarf*) {
  return true;
}

static bool op_bra(Dwarf*) {
  return true;
}

static bool op_eq(Dwarf*) {
  return true;
}

static bool op_ge(Dwarf*) {
  return true;
}

static bool op_gt(Dwarf*) {
  return true;
}

static bool op_le(Dwarf*) {
  return true;
}

static bool op_lt(Dwarf*) {
  return true;
}

static bool op_ne(Dwarf*) {
  return true;
}

static bool op_skip(Dwarf*) {
  return true;
}

static bool op_lit(Dwarf* dwarf) {
  dwarf->InternalStackPush(dwarf->cur_op() - 0x30);
  return true;
}

static bool op_reg(Dwarf*) {
  return true;
}

static bool op_breg(Dwarf*) {
  return true;
}

static bool op_regx(Dwarf*) {
  return true;
}

static bool op_fbreg(Dwarf*) {
  return true;
}

static bool op_bregx(Dwarf*) {
  return true;
}

static bool op_piece(Dwarf*) {
  return true;
}

static bool op_deref_size(Dwarf*) {
  return true;
}

static bool op_xderef_size(Dwarf*) {
  return true;
}

static bool op_push_object_address(Dwarf*) {
  return true;
}

static bool op_call2(Dwarf*) {
  return true;
}

static bool op_call4(Dwarf*) {
  return true;
}

static bool op_call_ref(Dwarf*) {
  return true;
}

static bool op_form_tls_address(Dwarf*) {
  return true;
}

static bool op_call_frame_cfa(Dwarf*) {
  return true;
}

static bool op_bit_piece(Dwarf*) {
  return true;
}

static bool op_implicit_value(Dwarf*) {
  return true;
}

static bool op_stack_value(Dwarf*) {
  return true;
}

static bool op_nop(Dwarf*) {
  return true;
}

DwarfCallback g_opcode_table[256] = {
