...
#ifndef _LIBANDROID_UNWIND_DWARF_STRUCTS_H
#define _LIBANDROID_UNWIND_DWARF_STRUCTS_H
...
typedef std::unordered_map<uint16_t, DwarfLocation> dwarf_regs_t;

#endif // _LIBANDROID_UNWIND_DWARF_STRUCTS_H
