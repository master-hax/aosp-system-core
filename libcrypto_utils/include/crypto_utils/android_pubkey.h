 ...
 *
 * Returns 1 if successful, in which case the caller receives ownership of the
 * |*key| object, i.e. needs to call RSA_free() when done with it. If there is
 * an error, |key| is left untouched and the return value will be 0.
 */
