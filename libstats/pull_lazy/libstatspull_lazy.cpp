...
void AStatsManager_PullAtomMetadata_release(AStatsManager_PullAtomMetadata* metadata) {
    INVOKE_VOID_METHOD(AStatsManager_PullAtomMetadata_release, metadata);
}

void AStatsManager_PullAtomMetadata_setCoolDownMillis(AStatsManager_PullAtomMetadata* metadata,
                                                      int64_t cool_down_millis) {
    INVOKE_VOID_METHOD(AStatsManager_PullAtomMetadata_setCoolDownMillis, metadata,
                       cool_down_millis);
}
...
void AStatsManager_PullAtomMetadata_setTimeoutMillis(AStatsManager_PullAtomMetadata* metadata,
    ...
    INVOKE_VOID_METHOD(AStatsManager_PullAtomMetadata_setTimeoutMillis, metadata, timeout_millis);
}
...
void AStatsManager_PullAtomMetadata_setAdditiveFields(AStatsManager_PullAtomMetadata* metadata,
                                                      ...
                                                      int32_t num_fields) {
    INVOKE_VOID_METHOD(AStatsManager_PullAtomMetadata_setAdditiveFields, metadata, additive_fields,
                       num_fields);
}
...
void AStatsManager_PullAtomMetadata_getAdditiveFields(AStatsManager_PullAtomMetadata* metadata,
                                                      int32_t* fields) {
    INVOKE_VOID_METHOD(AStatsManager_PullAtomMetadata_getAdditiveFields, metadata, fields);
}
...
void AStatsManager_setPullAtomCallback(int32_t atom_tag, AStatsManager_PullAtomMetadata* metadata,
    ...
    INVOKE_VOID_METHOD(AStatsManager_setPullAtomCallback, atom_tag, metadata, callback, cookie);
}

void AStatsManager_clearPullAtomCallback(int32_t atom_tag) {
    INVOKE_VOID_METHOD(AStatsManager_clearPullAtomCallback, atom_tag);
}
