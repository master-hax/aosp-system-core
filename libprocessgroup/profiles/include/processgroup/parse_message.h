...
static std::string GetTypeUrl(const google::protobuf::Descriptor* message) {
...
template <typename T>
ErrorOr<std::string> MessageToJsonString(const T& object) {
    using google::protobuf::DescriptorPool;
    using google::protobuf::scoped_ptr;
    ...
    auto status = BinaryToJsonString(
            resolver.get(),
            GetTypeUrl(object.GetDescriptor(), object.SerializeAsString(), &json, options));
