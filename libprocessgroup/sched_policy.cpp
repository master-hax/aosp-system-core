...
int set_cpuset_policy(int tid, SchedPolicy policy) {
    ...
    switch (policy) {
        case SP_BACKGROUND:
            return SetTaskProfile(tid, "CPUSET_SP_BACKGROUND", true) ? 0 : -1;
        case SP_FOREGROUND:
        case SP_AUDIO_APP:
        case SP_AUDIO_SYS:
            return SetTaskProfile(tid, "CPUSET_SP_FOREGROUND", true) ? 0 : -1;
        case SP_TOP_APP:
            return SetTaskProfile(tid, "CPUSET_SP_TOP_APP", true) ? 0 : -1;
        case SP_SYSTEM:
            return SetTaskProfile(tid, "CPUSET_SP_SYSTEM", true) ? 0 : -1;
        case SP_RESTRICTED:
            return SetTaskProfile(tid, "CPUSET_SP_RESTRICTED", true) ? 0 : -1;
        default:
            break;
    }
...
int set_sched_policy(int tid, SchedPolicy policy) {
    ...
    switch (policy) {
        case SP_BACKGROUND:
            return SetTaskProfile(tid, "SCHED_SP_BACKGROUND", true) ? 0 : -1;
        case SP_FOREGROUND:
        case SP_AUDIO_APP:
        case SP_AUDIO_SYS:
            return SetTaskProfile(tid, "SCHED_SP_FOREGROUND", true) ? 0 : -1;
        case SP_TOP_APP:
            return SetTaskProfile(tid, "SCHED_SP_TOP_APP", true) ? 0 : -1;
        case SP_RT_APP:
            return SetTaskProfile(tid, "SCHED_SP_RT_APP", true) ? 0 : -1;
        default:
            return SetTaskProfile(tid, "SCHED_SP_DEFAULT", true) ? 0 : -1;
    }
