...
template <typename T>
bool TaskProfiles::SetProcessProfilesT(
...
template <typename T>
bool TaskProfiles::SetTaskProfilesT(int tid, T profiles,
...
template bool TaskProfiles::SetProcessProfilesT(
...
template bool TaskProfiles::SetProcessProfilesT(
        ...
        const std::function<bool(TaskProfile*, uid_t, pid_t)>& execute_for_process,
        bool use_fd_cache);
template bool TaskProfiles::SetTaskProfilesT(
        int tid, const std::vector<std::string>& profiles,
        const std::function<bool(TaskProfile*, int)>& execute_for_task, bool use_fd_cache);
template bool TaskProfiles::SetTaskProfilesT(
        int tid, std::span<std::string_view> profiles,
        const std::function<bool(TaskProfile*, int)>& execute_for_task, bool use_fd_cache);
template bool TaskProfiles::SetTaskProfilesT(
        int tid, std::span<const char*> profiles,
        const std::function<bool(TaskProfile*, int)>& execute_for_task, bool use_fd_cache);
