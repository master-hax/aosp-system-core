...
static CgroupDescriptorMap* LoadRcFile() {
...
static const CgroupDescriptorMap* GetInstance() {
    ...
    static const CgroupDescriptorMap* descriptors = LoadRcFile();
    return descriptors;
}
...
const ACgroupController* ACgroupFile_getController(uint32_t index) {
    ...
    // member functions.
    // Yikes, don't do this at home kids... Here we're stuck with this interface.
