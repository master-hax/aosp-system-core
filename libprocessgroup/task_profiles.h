...
class SetAttributeAction : public ProfileAction {
  public:
    SetAttributeAction(
            ...
            std::optional<std::map<std::string, std::string, std::less<>>::iterator> maybeIterator,
            bool optional)
        : attribute_(attribute),
          value_(value),
          maybeIterator_(maybeIterator),
          optional_(optional) {}
  ...
  private:
    ...
    std::string value_;
    std::optional<std::map<std::string, std::string, std::less<>>::iterator> maybeIterator_;
    bool optional_;
};
