...
class IProfileVariable {
  public:
    ...
    virtual void Reset(const std::string& variable_name, const std::string& variable_value) = 0;
    virtual const std::string& variable_name() const = 0;
    virtual const std::string& variable_value() const = 0;
};
...
class ProfileVariable : public IProfileVariable {
  public:
    ProfileVariable(const std::string& variable_name, const std::string& variable_value)
        : variable_name_(variable_name), variable_value_(variable_value) {}
    ~ProfileVariable() = default;

    const std::string& variable_name() const override { return variable_name_; }
    const std::string& variable_value() const override { return variable_value_; }
    void Reset(const std::string& variable_name, const std::string& variable_value) override;
...
class TaskProfiles {
  public:
    ...
    const IProfileVariable* GetProfileVariable(std::string_view name) const;
    ...
    bool SetVariableProfiles(std::vector<std::pair<std::string, std::string>> profile_variables);
