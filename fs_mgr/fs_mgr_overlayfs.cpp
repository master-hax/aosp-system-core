...
std::vector<std::string> fs_mgr_overlayfs_candidate_list(Fstab* fstab, const char* mount_point) {
    return {};
}
...
bool fs_mgr_overlayfs_mount_all(Fstab* fstab) {
    ...
    for (const auto& mount_point : fs_mgr_overlayfs_candidate_list(fstab)) {
...
bool fs_mgr_overlayfs_setup(const char* backing, const char* mount_point, bool* change) {
    ...
    errno = save_errno;
    auto mounts = fs_mgr_overlayfs_candidate_list(&fstab, fs_mgr_mount_point(mount_point));
