...
void BuilderFuzzer::setupSuperLayoutBuilder(string fuzzPartitionName) {
...
void BuilderFuzzer::addMultiplePartitions(int32_t numPartitions) {
...
void BuilderFuzzer::callRandomOpen(int32_t open) {
...
void BuilderFuzzer::invokeSuperLayoutBuilderAPIs() {
