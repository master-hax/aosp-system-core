...
TEST_F(BuilderTest, VerifyExtent) {
    ...
    ASSERT_TRUE(target_builder->VerifyExtentsAgainstSourceMetadata(
            std::vector<std::string>{"system", "vendor"}, *source_builder, 0, 1));

    target_builder->RemovePartition("vendor_b");
    ASSERT_FALSE(target_builder->VerifyExtentsAgainstSourceMetadata(
            std::vector<std::string>{"vendor"}, *source_builder, 0, 1));
