...
typedef struct LpMetadataGeometry {
    ...
    /*  8: CRC32 checksum of this struct, with this field set to 0. */
    uint32_t checksum;

    /* 12: Maximum amount of space a single copy of the metadata can use. */
    uint32_t metadata_max_size;

    /* 16: Number of copies of the metadata to keep. For A/B devices, this
    ...
    /* 20: First usable sector for allocating logical partitions. this will be
    ...
    /* 28: Last usable sector, inclusive, for allocating logical partitions.
...
typedef struct LpMetadataHeader {
    ...
    /* 24: Partition table descriptor. */
    LpMetadataTableDescriptor partitions;
    /* 36: Extent table descriptor. */
