...
class MetadataBuilder {
  public:
    ...
    // Verifies that the given partitions in the metadata have the same extents as the the source
    // metadata.
    bool VerifyExtentsAgainstSourceMetadata(uint32_t target_slot_number,
                                            const MetadataBuilder& source_metadata,
                                            uint32_t source_slot_number,
