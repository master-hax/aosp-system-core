...
TEST(liblp, UpdateRetrofit) {
    ...
    ASSERT_EQ(updated->groups.size(), static_cast<size_t>(2));
    ASSERT_EQ(GetPartitionGroupName(updated->groups[0]), "default");
    ASSERT_EQ(GetPartitionGroupName(updated->groups[1]), "example_b");
