...
class SnapuserdTest : public ::testing::Test {
  protected:
    void SetUp() override {
        ...
        // Create temp files under /data/nativetest as selinux
        ...
        system_a_ = std::make_unique<TemporaryFile>("/data/nativetest");
        ASSERT_GE(system_a_->fd, 0) << strerror(errno);

        product_a_ = std::make_unique<TemporaryFile>("/data/nativetest");
