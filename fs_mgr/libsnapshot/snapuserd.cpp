    ...
    switch (header->type) {
        case DM_USER_REQ_MAP_READ: {
            ...
            do {
                ...
                if (!WriteDmUserPayload(read_size) || (header->type == DM_USER_RESP_ERROR)) {
                    return false;
                }
        ...
        case DM_USER_REQ_MAP_WRITE: {
            ...
            // responsibilty of the target driver - which is dm-user in this
            ...
            if (!WriteDmUserPayload(0) || (header->type == DM_USER_RESP_ERROR)) {
                return false;
            }
