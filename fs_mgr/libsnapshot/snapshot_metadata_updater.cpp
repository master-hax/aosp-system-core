...
bool SnapshotMetadataUpdater::DeleteGroups() const {
    ...
    for (const auto& existing_group_name : existing_groups) {
        ...
        // Update package metadata doesn't have this group. Before deleting it, Validity check that
        // it doesn't have any partitions left. Update metadata shouldn't assign any partitions to
