...
bool SnapshotMetadataUpdater::DeleteGroups() const {
    ...
    for (const auto& existing_group_name : existing_groups) {
        ...
        // Update package metadata doesn't have this group. Before deleting it, rationality check
        // that it doesn't have any partitions left. Update metadata shouldn't assign any partitions
        // to this group, so all partitions that originally belong to this group should be moved by
