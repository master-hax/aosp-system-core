...
struct ArgReader<T, typename std::enable_if_t<std::is_base_of_v<google::protobuf::Message, T>>> {
    using ret_type = const T&;
    static ret_type Get(const google::protobuf::Message& action_proto,
                        const google::protobuf::FieldDescriptor* field_desc) {
...
struct ArgReader<void> {
    using ret_type = bool;
    static bool Get(const google::protobuf::Message&, const google::protobuf::FieldDescriptor*) {
        return false;
    }
};
...
#define FUZZ_FUNCTION(Action, FunctionName, module, ArgMessageType, args)                          \
    class FUZZ_FUNCTION_CLASS_NAME(Action, FunctionName) {                                         \
      public:                                                                                      \
        static void ImplBody(Action::Class*,                                                       \
                             typename android::fuzz::ArgReader<ArgMessageType>::ret_type args);    \
                                                                                                   \
      private:                                                                                     \
    ...
    void FUZZ_FUNCTION_CLASS_NAME(Action, FunctionName)::ImplBodyWithField(                        \
            ...
            const google::protobuf::FieldDescriptor* field_desc) {                                 \
        ImplBody(module, android::fuzz::ArgReader<ArgMessageType>::Get(action_proto, field_desc)); \
    }                                                                                              \
    void FUZZ_FUNCTION_CLASS_NAME(Action, FunctionName)::ImplBody(                                 \
            [[maybe_unused]] Action::Class* module,                                                \
            [[maybe_unused]] typename android::fuzz::ArgReader<ArgMessageType>::ret_type args)
...
#define FUZZ_SIMPLE_FUNCTION(Action, FunctionName) \
    FUZZ_FUNCTION(Action, FunctionName, module, void, args) { (void)module->FunctionName(); }
