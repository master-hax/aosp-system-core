...
bool SnapshotManager::IsUserspaceSnapshots() {
    return (IsCompressionEnabled() && IsUserspaceSnapshotsEnabled());
}
...
bool SnapshotManager::CollapseSnapshotDevice(const std::string& name,
    ...
    // the reference
    if (IsUserspaceSnapshots() && EnsureSnapuserdConnected()) {
