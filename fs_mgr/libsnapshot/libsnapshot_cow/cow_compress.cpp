...
std::basic_string<uint8_t> GzCompressor::Compress(const void* data, size_t length) const {
...
std::basic_string<uint8_t> Lz4Compressor::Compress(const void* data, size_t length) const {
...
std::basic_string<uint8_t> BrotliCompressor::Compress(const void* data, size_t length) const {
