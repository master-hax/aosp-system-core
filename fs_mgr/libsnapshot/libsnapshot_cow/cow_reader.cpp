...
bool ReadResumeBuffer(android::base::borrowed_fd fd, std::vector<ResumePoint>& resume_points,
    ...
    resume_points.clear();
    resume_points.resize(header.resume_buffer_size / sizeof(ResumePoint));

    return android::base::ReadFullyAtOffset(fd, resume_points.data(), header.resume_buffer_size,
