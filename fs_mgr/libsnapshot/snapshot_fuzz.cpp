...
#define SNAPSHOT_FUZZ_FUNCTION(FunctionName, args) \
    FUZZ_FUNCTION(SnapshotManagerAction, FunctionName, snapshot, args)
...
SNAPSHOT_FUZZ_FUNCTION(Dump, Void) {
    std::stringstream ss;
