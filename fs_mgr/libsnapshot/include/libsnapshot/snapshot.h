...
enum class RetCode : unsigned int {
    ERROR,
    CREATED,
    NOT_CREATED,
};
...
class SnapshotManager final {
  ...
  public:
    ...
    // - RetCode::CREATED if snapshot devices were successfully created;
    // - RetCode::NOT_CREATED if it was not necessary to create snapshot devices;
    // - RetCode::ERROR if a fatal error occurred, mounting /system should be aborted.
    RetCode FirstStageCreateSnapshotDevices();
