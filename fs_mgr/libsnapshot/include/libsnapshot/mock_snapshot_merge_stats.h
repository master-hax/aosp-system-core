...
#ifndef ANDROID_SNAPSHOT_MOCK_SNAPSHOT_MERGE_STATS_H_
#define ANDROID_SNAPSHOT_MOCK_SNAPSHOT_MERGE_STATS_H_
...
#endif  // ANDROID_SNAPSHOT_MOCK_SNAPSHOT_MERGE_STATS_H_
