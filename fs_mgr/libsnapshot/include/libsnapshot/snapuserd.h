...
// Represents default number of sectors to read/write from COW from kernel.
// Since each sector is 512 bytes; 8*512 = 4096 bytes.
#define CHUNK_SIZE 8
#define CHUNK_SHIFT (__builtin_ffs(CHUNK_SIZE) - 1)
