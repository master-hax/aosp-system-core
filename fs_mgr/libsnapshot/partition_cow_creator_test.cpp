...
TEST(PartitionCowCreator, IntersectSelf) {
    ...
    PartitionCowCreator creator{
        .target_metadata = builder_b.get(),
        .target_suffix = "_b",
    ...
    ASSERT_EQ(40 * 1024, ret->device_size);
    ASSERT_EQ(40 * 1024, ret->snapshot_size);
    ASSERT_EQ(20 * 1024, ret->cow_file_size + ret->cow_partition_size);
}
