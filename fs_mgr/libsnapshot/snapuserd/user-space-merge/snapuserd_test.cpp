...
// TODO: Client communication with the new user-space-merge server
// is not yet established. As part of that communication, we will have to
// send additional argument to "InitDmUserCow" wherein the final
// argument will be the "Base" device for merging.
//
// For now, disable it to pass the compilation
#if 0
