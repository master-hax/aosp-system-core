    ...
    do {
        ...
        while (read_size) {
            ...
            auto it = std::lower_bound(chunk_vec.begin(), chunk_vec.end(),
                                       std::make_pair(sector, nullptr), Snapuser::compare);
