...
<<<<<<< TARGET BRANCH (cb6ea9 Merge "libsnapshot: Disable 32-bit VTS tests on 64-bit syste)
    cow_creator.compression_enabled = ShouldUseCompression();
=======
    cow_creator.compression_enabled = DeviceSupportsCompression();
>>>>>>> SOURCE BRANCH (5141ea Merge "Merge "libsnapshot: Fix test failures on certain conf)
