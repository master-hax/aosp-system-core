...
class SnapshotTest : public ::testing::Test {
  ...
  protected:
    ...
    AssertionResult DeleteSnapshotDevice(const std::string& snapshot) {
        ...
        if (!(res = DeleteDevice(snapshot + "-cow-lin"))) return res;
...
TEST_F(SnapshotUpdateTest, FullUpdateFlow) {
    ...
    ASSERT_NE(nullptr, tgt->FindPartition("sys_b-cow-lin"));
    ASSERT_NE(nullptr, tgt->FindPartition("vnd_b-cow-lin"));
    ASSERT_EQ(nullptr, tgt->FindPartition("prd_b-cow-lin"));
    ...
    // Initiate the merge and wait for it it be completed.
    ASSERT_TRUE(init->InitiateMerge());
