...
#else
bool DeviceMapper::GetTableStatusIma(const std::string& name ATTRIBUTE_UNUSED, std::vector<TargetInfo>* table ATTRIBUTE_UNUSED) {
    LOG(ERROR) << "DM_IMA_MEASUREMENT_FLAG is not supported";
    return false;
#endif
}
