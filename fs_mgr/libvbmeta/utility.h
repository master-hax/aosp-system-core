...
// Helper to validate vbmeta (equal to result), which is |size| bytes at |offset| in file |fd|.
android::base::Result<bool> ValidateVBMetaWithResult(int fd, uint64_t offset, uint64_t size,
