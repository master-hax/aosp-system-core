...
static void tune_quota(const std::string& blk_device, const FstabEntry& entry,
    ...
    bool want_projid = android::base::GetBoolProperty("ro.external_storage.projid.enabled", false);
...
static void tune_casefold(const std::string& blk_device, const struct ext4_super_block* sb,
    ...
    bool wants_casefold =
            android::base::GetBoolProperty("ro.external_storage.casefold.enabled", false);
