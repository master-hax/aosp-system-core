...
static bool ConfigureIoScheduler(const std::string& device_path) {
    ...
    std::ostringstream iosched_path_stream;
    iosched_path_stream << "/sys/block/" << Basename(device_path) << "/queue/scheduler";
    const std::string iosched_path = iosched_path_stream.str();
