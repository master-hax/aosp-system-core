...
#define ENCRYPT_SUCC "1"
#define DATA_ENCRYPT_FILE "/metadata/vold/metadata_encryption/encrypt_file"
...
static bool get_encrypt_status() {
  std::string value;
  if (!android::base::ReadFileToString(DATA_ENCRYPT_FILE, &value)) {
    return false;
  }

  if (value == ENCRYPT_SUCC) {
    return true;
  }
  return false;
}
