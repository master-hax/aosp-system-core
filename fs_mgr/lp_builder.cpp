...
bool MetadataBuilder::Init(const LpMetadata& metadata) {
    header_.first_logical_sector = metadata.header.first_logical_sector;
    header_.last_logical_sector = metadata.header.last_logical_sector;
    header_.metadata_reserved = metadata.header.metadata_reserved;
