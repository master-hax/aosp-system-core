...
// Returns a |mount_all_outcome|. The first element is one of the FS_MNG_MNTALL_* return codes
...
mount_all_outcome fs_mgr_mount_all(android::fs_mgr::Fstab* fstab, int mount_mode);
