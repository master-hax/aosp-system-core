...
// Returns true if mount_point exists and is a canonical path that doesn't
// contain any symbolic link or /../.
bool fs_mgr_mount_point_is_canonical(const std::string& mount_point);
