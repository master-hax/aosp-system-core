...
using android::fs_mgr::kAvbHandleHashtreeDisabled;
using android::fs_mgr::kAvbHandleSuccess;
using android::fs_mgr::kAvbHandleVerificationDisabled;
using android::fs_mgr::kAvbHandleVerificationError;
using android::fs_mgr::kSHA256;
using android::fs_mgr::kSHA512;
...
TEST_F(PublicFsAvbTest, LoadAndVerifyVbmeta) {
    ...
    auto avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            ...
            "" /* expected_public_key_blob*/, kSHA256, false /* allow_verification_error */,
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_NE(nullptr, avb_handle);
    EXPECT_EQ(kAvbHandleSuccess, avb_handle->status());
    ...
    EXPECT_EQ(kSHA256, avb_handle->vbmeta_info().hash_algorithm);

    // Skip loading chained vbmeta.
    avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            "vbmeta" /* partition_name */, "" /* ab_suffix */, "" /* other_suffix */,
            "" /* expected_public_key_blob*/, kSHA256, false /* allow_verification_error */,
            false /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_NE(nullptr, avb_handle);
    EXPECT_EQ(kAvbHandleSuccess, avb_handle->status());
...
TEST_F(PublicFsAvbTest, LoadAndVerifyVbmetaWithModifications) {
    ...
    avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            "vbmeta" /* partition_name */, "" /* ab_suffix */, "" /* other_suffix */,
            "" /* expected_public_key_blob*/, kSHA256, true /* allow_verification_error */,
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_NE(nullptr, avb_handle);
    EXPECT_EQ(kAvbHandleHashtreeDisabled, avb_handle->status());
    ...
    avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            ...
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_NE(nullptr, avb_handle);
    EXPECT_EQ(kAvbHandleVerificationDisabled, avb_handle->status());
    ...
    // Sets a unknown flag in the vbmeta.imgm and expects to get kAvbHandleVerificationError.
    ...
    avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            ...
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_NE(nullptr, avb_handle);
    EXPECT_EQ(kAvbHandleVerificationError, avb_handle->status());
    // Checks the digest matches the value calculated by CalcVBMetaDigest().
...
TEST_F(PublicFsAvbTest, LoadAndVerifyVbmetaWithPublicKeys) {
    ...
    auto avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            "vbmeta" /* partition_name */, "" /* ab_suffix */, "" /* other_suffix */,
            rsa8192_public_key.value(), kSHA256, true /* allow_verification_error */,
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_NE(nullptr, avb_handle);
    EXPECT_EQ(kAvbHandleSuccess, avb_handle->status());
    ...
    avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            "vbmeta" /* partition_name */, "" /* ab_suffix */, "" /* other_suffix */,
            "/path/to/non-existed/key", kSHA256, true /* allow_verification_error */,
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_EQ(nullptr, avb_handle);
    ...
    avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            "vbmeta" /* partition_name */, "" /* ab_suffix */, "" /* other_suffix */,
            rsa4096_public_key.value(), kSHA256, false /* allow_verification_error */,
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_EQ(nullptr, avb_handle);
    ...
    avb_handle = AvbHandle::LoadAndVerifyVbmeta(
            "vbmeta" /* partition_name */, "" /* ab_suffix */, "" /* other_suffix */,
            rsa4096_public_key.value(), kSHA256, true /* allow_verification_error */,
            true /* load_chained_vbmeta */, true /* rollback_protection */, vbmeta_image_path);
    EXPECT_NE(nullptr, avb_handle);
    EXPECT_EQ(kAvbHandleVerificationError, avb_handle->status());
}
