...
static int do_send_recv(struct ipc_obj* obj, const void* data, int data_size, void* rsp,
                        int rsp_size) {
    int rc;
...
static int trusty_loader_call(struct ipc_obj* obj, const struct loader_req* req,
...
static int trusty_loader_cmd(struct ipc_obj* obj, int cmd, const void* payload, int payload_size,
                             int* rsp) {
    int rc;
