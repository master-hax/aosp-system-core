 ...
 *
 */
int storage_read(file_handle_t handle,
 ...
 *
 */
int storage_write_ext(file_handle_t handle,
                      storage_off_t off, const void *buf, size_t size,
                      uint32_t opflags);

static int storage_write(file_handle_t handle,
                         storage_off_t off, const void *buf, size_t size)
{
    return storage_write_ext(handle, off, buf, size, STORAGE_OP_COMPLETE);
}
 ...
 *
 */
int storage_set_file_size_ext(file_handle_t handle,
                              storage_off_t file_size, uint32_t opflags);

static int storage_set_file_size(file_handle_t handle,
                                 storage_off_t file_size)
{
    return storage_set_file_size_ext(handle, file_size, STORAGE_OP_COMPLETE);
}
