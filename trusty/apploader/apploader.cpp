...
static ssize_t read_response(int tipc_fd) {
    ...
    switch (resp.error) {
        ...
        case APPLOADER_ERR_ALREADY_EXISTS:
            ...
            break;
        case APPLOADER_ERR_ALREADY_STARTED:
            fprintf(stderr, "Error: application already running\n");
            break;
        case APPLOADER_ERR_OTHER:
            fprintf(stderr, "Error: unspecified apploader error\n");
            break;
        default:
