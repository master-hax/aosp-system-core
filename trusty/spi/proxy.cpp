...
static inline int ReadMsg(int fd, void* hdr, size_t hdr_sz, void* msg, size_t msg_sz) {
    iovec iov[] = {
            {
                    .iov_base = hdr,
                    .iov_len = hdr_sz,
...
static inline int WriteMsg(int fd, void* hdr, size_t hdr_sz, void* msg, size_t msg_sz) {
    iovec iov[] = {
            {
                    .iov_base = hdr,
                    .iov_len = hdr_sz,
