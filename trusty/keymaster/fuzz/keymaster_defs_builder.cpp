...
const uint8_t hello[12] = "hello world";
    ...
    switch (invariant) {
        case Invariant::GenerateKey: {
            set = keymaster::AuthorizationSetBuilder()
                          ...
                          .Authorization(keymaster::TAG_APPLICATION_ID, app_id)
                          .Authorization(keymaster::TAG_APPLICATION_DATA, app_data)
                          .build();
        ...
        default: {
            ABORT("Can't build AuthSet for unknown test case\n");
        }
    }
}
