...
extern keymaster::GenerateKeyResponse gen_key_resp;
...
bool BuildBeginOpMsg(const fuzz::BeginOperationRequest& proto_req,
    ...
    switch (invariant) {
        case Invariant::BeginOp: {
            ...
            req.SetKeyMaterial(gen_key_resp.key_blob);
            BuildAuthorizationSet(proto_req.additional_params(), req.additional_params, invariant);
            break;
        }
        default: {
            return false;
