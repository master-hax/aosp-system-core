...
#define METRICS_MAX_MSG_SIZE                                                       \
    MAX( (sizeof(struct metrics_req) + sizeof(struct metrics_report_crash_req) +   \
     METRICS_MAX_APP_ID_LEN),                                                      \
        (sizeof(struct metrics_req) + sizeof(struct metrics_report_storage_error_req) + \
     METRICS_MAX_APP_ID_LEN + METRICS_MAX_APP_ID_LEN)                              \
    )

union metrics_crash_msg {
