 ...
 * :func:`tipc_connect`, initializing a connection to a specified Trusty
 * service. Internally, :func:`tipc_connect` call opens a specified device node
 * to obtain a file descriptor and invokes a %TIPC_IOC_CONNECT :func:`ioctl`
 ...
 * calling :func:`tipc_close` when the connection is not required anymore.
 *
 * The file descriptor obtained by the :func:`tipc_connect` call behaves as a
 ...
 *    other side
 *  * Can be polled (using :func:`poll` calls or :func:`select` calls)
 ...
 * the specified `fd`. All data passed to the above :func:`write` call is
 ...
 * @fd: file descriptor returned by :func"`tipc_connect`
 ...
 * @fd: File descriptor previously opened by a :func:`tipc_connect` call
 *
