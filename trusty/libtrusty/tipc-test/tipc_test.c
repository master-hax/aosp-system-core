...
static int connect_test(struct tipc_test_params* params) {
    uint i;
    int echo_fd;
    int dsink_fd;
    int custom_fd;
...
static int connect_foo(struct tipc_test_params* params) {
    uint i;
    int fd;
...
static int closer1_test(struct tipc_test_params* params) {
    uint i;
    int fd;
...
static int closer2_test(struct tipc_test_params* params) {
    uint i;
    int fd;
...
static int closer3_test(struct tipc_test_params* params) {
    uint i, j;
    ssize_t rc;
    int fd[4];
    char buf[64];
...
static int echo_test(struct tipc_test_params* params) {
    uint i;
    ssize_t rc;
    size_t msg_len;
    int echo_fd = -1;
...
static int burst_write_test(struct tipc_test_params* params) {
    int fd;
    uint i, j;
    ssize_t rc;
    size_t msg_len;
...
static int _wait_for_msg(int fd, int timeout, struct tipc_test_params* params) {
    int rc;
    fd_set rfds;
    uint msgcnt = 0;
    char rx_buf[params->msgsize];
...
static int select_test(struct tipc_test_params* params) {
    int fd;
    uint i, j;
    ssize_t rc;
    char tx_buf[params->msgsize];
...
static int blocked_read_test(struct tipc_test_params* params) {
    int fd;
    uint i;
    ssize_t rc;
    char rx_buf[512];
...
static int ta2ta_ipc_test(struct tipc_test_params* params) {
...
static int dev_uuid_test(struct tipc_test_params* params) {
    int fd;
    ssize_t rc;
    uuid_t uuid;
...
static int ta_access_test(struct tipc_test_params* params) {
    int fd;
...
static int writev_test(struct tipc_test_params* params) {
    uint i;
    ssize_t rc;
    size_t msg_len;
    int echo_fd = -1;
...
static int readv_test(struct tipc_test_params* params) {
    uint i;
    ssize_t rc;
    size_t msg_len;
    int echo_fd = -1;
...
static int send_fd_test(struct tipc_test_params* params) {
    int ret;
    int dma_buf = -1;
    int fd = -1;
...
int (*get_test_function(struct tipc_test_params* params))(struct tipc_test_params* params) {
    if (strcmp(params->test_name, "connect") == 0) {
        return connect_test;
    } else if (strcmp(params->test_name, "connect_foo") == 0) {
        return connect_foo;
    } else if (strcmp(params->test_name, "burst_write") == 0) {
        return burst_write_test;
    } else if (strcmp(params->test_name, "select") == 0) {
        return select_test;
    } else if (strcmp(params->test_name, "blocked_read") == 0) {
        return blocked_read_test;
    } else if (strcmp(params->test_name, "closer1") == 0) {
        return closer1_test;
    } else if (strcmp(params->test_name, "closer2") == 0) {
        return closer2_test;
    } else if (strcmp(params->test_name, "closer3") == 0) {
        return closer3_test;
    } else if (strcmp(params->test_name, "echo") == 0) {
        return echo_test;
    } else if (strcmp(params->test_name, "ta2ta-ipc") == 0) {
        return ta2ta_ipc_test;
    } else if (strcmp(params->test_name, "dev-uuid") == 0) {
        return dev_uuid_test;
    } else if (strcmp(params->test_name, "ta-access") == 0) {
        return ta_access_test;
    } else if (strcmp(params->test_name, "writev") == 0) {
        return writev_test;
    } else if (strcmp(params->test_name, "readv") == 0) {
        return readv_test;
    } else if (strcmp(params->test_name, "send-fd") == 0) {
        return send_fd_test;
    } else {
...
static int run_as_bench(struct tipc_test_params* params) {
    int rc = 0;
    ...
    int (*test)(struct tipc_test_params*) = get_test_function(params);
    ...
    fprintf(stderr, bench_result_tpl, params->test_name, min, max, avg, cold);
    return rc;
}
