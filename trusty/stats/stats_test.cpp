...
TEST_F(TrustyMetricsCrashTest, CheckTrustyCrashAtoms) {
    ...
    const std::vector<uint32_t> kExpectedCrashReasonsArm32{
            0x00000001U,  // exit_failure (twice)
            0x00000001U,
            0x30000007U,  // read_null_ptr
            0x30000007U,  // read_bad_ptr
            0x30000807U,  // crash_write_bad_ptr
            0x30000807U,  // crash_write_ro_ptr
            0x4000000fU,  // crash_exec_rodata
            0x4000000fU,  // crash_exec_data
    };
