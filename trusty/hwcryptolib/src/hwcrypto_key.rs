...
use android_hardware_security_see::aidl::android::hardware::security::see::hwcrypto::IHwCryptoKeyEcOperations::IHwCryptoKeyEcOperations;
...
use android_hardware_security_see::aidl::android::hardware::security::see::hwcrypto::IHwCryptoKeyHashOperations::IHwCryptoKeyHashOperations;
use android_hardware_security_see::aidl::android::hardware::security::see::hwcrypto::IHwCryptoKeyManipulation::IHwCryptoKeyManipulation;
...
use crate::hwcrypto_key_manipulation::HwCryptoKeyManipulation;
...
impl IHwCryptoKey for HwCryptoKey {
    ...
    fn get_key_manipulation(&self) -> binder::Result<binder::Strong<dyn IHwCryptoKeyManipulation>> {
        HwCryptoKeyManipulation::new_operation()
    }
