...
use android_hardware_security_see::aidl::android::hardware::security::see::hwcrypto::base_types::{
    AccumulatingOperationResult::AccumulatingOperationResult, OpaqueKeyMaterial::OpaqueKeyMaterial,
    RsaDecryptParameters::RsaDecryptParameters, RsaSignParameters::RsaSignParameters,
...
impl IHwCryptoKeyRsaOperations for HwCryptoKeyRsaOperations {
    ...
    fn get_public_key(&self, _key: &OpaqueKeyMaterial) -> binder::Result<VectorResult> {
