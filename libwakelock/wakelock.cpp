...
WakeLock::WakeLockImpl::WakeLockImpl(const std::string& name) : mReleased(), mWakeLock(nullptr) {
...
void WakeLock::WakeLockImpl::release() {
    releaseOnce();
}

void WakeLock::WakeLockImpl::releaseOnce() {
